 ...
 */
public class ScrollingListOld extends View
{
    ...
    //  Runtime
    protected ScrollingListOldContainer scrollView;
    protected DataProvider              dataProvider;
    protected int     barClickY  = 0;
    protected boolean barClicked = false;

    public ScrollingListOld(){ super(); }

    public ScrollingListOld(ScrollingListOld other){ super(other); }
     ...
     */
    public ScrollingListOld(PaneParams params)
    {
        super(params);
    }
    ...
    {
        scrollView = new ScrollingListOldContainer(this);
