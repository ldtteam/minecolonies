...
public final class ModItems
{
     ...
     * Building blocks.
     */
    public static final BlockItem blockItemHutTownHall      = registerBlock(ModBlocks.blockHutTownHall);
    public static final BlockItem blockItemHutCitizen       = registerBlock(ModBlocks.blockHutCitizen);
    public static final BlockItem blockItemHutMiner         = registerBlock(ModBlocks.blockHutMiner);
    public static final BlockItem blockItemHutLumberjack    = registerBlock(ModBlocks.blockHutLumberjack);
    public static final BlockItem blockItemHutBaker         = registerBlock(ModBlocks.blockHutBaker);
    public static final BlockItem blockItemHutBuilder       = registerBlock(ModBlocks.blockHutBuilder);
    public static final BlockItem blockItemHutDeliveryman   = registerBlock(ModBlocks.blockHutDeliveryman);
    public static final BlockItem blockItemHutBlacksmith    = registerBlock(ModBlocks.blockHutBlacksmith);
    public static final BlockItem blockItemHutStonemason    = registerBlock(ModBlocks.blockHutStonemason);
    public static final BlockItem blockItemHutFarmer        = registerBlock(ModBlocks.blockHutFarmer);
    public static final BlockItem blockItemHutFisherman     = registerBlock(ModBlocks.blockHutFisherman);
    public static final BlockItem blockItemHutGuardTower    = registerBlock(ModBlocks.blockHutGuardTower);
    public static final BlockItem blockItemHutWareHouse     = registerBlock(ModBlocks.blockHutWareHouse);
    public static final BlockItem blockItemHutShepherd      = registerBlock(ModBlocks.blockHutShepherd);
    public static final BlockItem blockItemHutCowboy        = registerBlock(ModBlocks.blockHutCowboy);
    public static final BlockItem blockItemHutSwineHerder   = registerBlock(ModBlocks.blockHutSwineHerder);
    public static final BlockItem blockItemHutChickenHerder = registerBlock(ModBlocks.blockHutChickenHerder);
    public static final BlockItem blockItemHutBarracks      = registerBlock(ModBlocks.blockHutBarracks);
    public static final BlockItem blockItemHutBarracksTower = registerBlock(ModBlocks.blockHutBarracksTower);
    public static final BlockItem blockItemHutCook          = registerBlock(ModBlocks.blockHutCook);
    public static final BlockItem blockItemHutSmeltery      = registerBlock(ModBlocks.blockHutSmeltery);
    public static final BlockItem blockItemHutComposter     = registerBlock(ModBlocks.blockHutComposter);
    public static final BlockItem blockItemHutLibrary       = registerBlock(ModBlocks.blockHutLibrary);
    public static final BlockItem blockItemHutArchery       = registerBlock(ModBlocks.blockHutArchery);
    public static final BlockItem blockItemHutCombatAcademy = registerBlock(ModBlocks.blockHutCombatAcademy);
    public static final BlockItem blockItemHutSawmill       = registerBlock(ModBlocks.blockHutSawmill);
    public static final BlockItem blockItemHutStoneSmeltery = registerBlock(ModBlocks.blockHutStoneSmeltery);
    public static final BlockItem blockItemHutCrusher       = registerBlock(ModBlocks.blockHutCrusher);
    public static final BlockItem blockItemHutSifter        = registerBlock(ModBlocks.blockHutSifter);
    public static final BlockItem blockItemHutFlorist       = registerBlock(ModBlocks.blockHutFlorist);
    public static final BlockItem blockItemHutEnchanter     = registerBlock(ModBlocks.blockHutEnchanter);
    public static final BlockItem blockItemHutUniversity    = registerBlock(ModBlocks.blockHutUniversity);
    public static final BlockItem blockItemHutHospital      = registerBlock(ModBlocks.blockHutHospital);
    public static final BlockItem blockItemHutSchool        = registerBlock(ModBlocks.blockHutSchool);
    public static final BlockItem blockItemHutGlassblower   = registerBlock(ModBlocks.blockHutGlassblower);
    public static final BlockItem blockItemHutDyer          = registerBlock(ModBlocks.blockHutDyer);
    public static final BlockItem blockItemHutFletcher      = registerBlock(ModBlocks.blockHutFletcher);
    public static final BlockItem blockItemHutMechanic      = registerBlock(ModBlocks.blockHutMechanic);
    public static final BlockItem blockItemHutPlantation    = registerBlock(ModBlocks.blockHutPlantation);
    public static final BlockItem blockItemHutTavern        = registerBlock(ModBlocks.blockHutTavern);
    public static final BlockItem blockItemHutRabbitHutch   = registerBlock(ModBlocks.blockHutRabbitHutch);
    public static final BlockItem blockItemHutConcreteMixer = registerBlock(ModBlocks.blockHutConcreteMixer);
    public static final BlockItem blockItemHutBeekeeper     = registerBlock(ModBlocks.blockHutBeekeeper);
    public static final BlockItem blockItemHutMysticalSite  = registerBlock(ModBlocks.blockHutMysticalSite);
    public static final BlockItem blockItemHutGraveyard     = registerBlock(ModBlocks.blockHutGraveyard);
    public static final BlockItem blockItemHutNetherWorker  = registerBlock(ModBlocks.blockHutNetherWorker);
    public static final BlockItem blockItemHutSimpleQuarry  = registerBlock(ModBlocks.blockHutSimpleQuarry);
    public static final BlockItem blockItemHutMediumQuarry  = registerBlock(ModBlocks.blockHutMediumQuarry);
    //public static final BlockItem blockItemHutLargeQuarry  = registerBlock(ModBlocks.blockHutLargeQuarry>);
    public static final BlockItem blockItemHutAlchemist     = registerBlock(ModBlocks.blockHutAlchemist);
    public static final BlockItem blockItemHutKitchen       = registerBlock(ModBlocks.blockHutKitchen);
    public static final BlockItem blockItemHutGateHouse     = registerBlock(ModBlocks.blockHutGateHouse);
