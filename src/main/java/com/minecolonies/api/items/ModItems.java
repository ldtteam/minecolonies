...
public final class ModItems
{
    ...
    public final static DeferredRegister<ArmorMaterial> DEFERRED_REGISTER = DeferredRegister.create(BuiltInRegistries.ARMOR_MATERIAL, Constants.MOD_ID);
    ...
    static
    {
         ...
         * Spawn egg colors.
         */
        final int PRIMARY_COLOR_BARBARIAN   = 5;
        final int SECONDARY_COLOR_BARBARIAN = 700;
        final int PRIMARY_COLOR_PIRATE      = 7;
        final int SECONDARY_COLOR_PIRATE    = 600;
        final int PRIMARY_COLOR_MERC        = 8;
        final int SECONDARY_COLOR_MERC      = 300;
        final int PRIMARY_COLOR_EG          = 10;
        final int SECONDARY_COLOR_EG        = 400;

        spawnEgg("barbarianegg", () -> ModEntities.BARBARIAN, PRIMARY_COLOR_BARBARIAN, SECONDARY_COLOR_BARBARIAN);
        spawnEgg("barbarcheregg", () -> ModEntities.ARCHERBARBARIAN, PRIMARY_COLOR_BARBARIAN, SECONDARY_COLOR_BARBARIAN);
        spawnEgg("barbchiefegg", () -> ModEntities.CHIEFBARBARIAN, PRIMARY_COLOR_BARBARIAN, SECONDARY_COLOR_BARBARIAN);

        spawnEgg("pirateegg", () -> ModEntities.PIRATE, PRIMARY_COLOR_PIRATE, SECONDARY_COLOR_PIRATE);
        spawnEgg("piratearcheregg", () -> ModEntities.ARCHERPIRATE, PRIMARY_COLOR_PIRATE, SECONDARY_COLOR_PIRATE);
        spawnEgg("piratecaptainegg", () -> ModEntities.CHIEFPIRATE, PRIMARY_COLOR_PIRATE, SECONDARY_COLOR_PIRATE);

        spawnEgg("mummyegg", () -> ModEntities.MUMMY, PRIMARY_COLOR_EG, SECONDARY_COLOR_EG);
        spawnEgg("mummyarcheregg", () -> ModEntities.ARCHERMUMMY, PRIMARY_COLOR_EG, SECONDARY_COLOR_EG);
        spawnEgg("pharaoegg", () -> ModEntities.PHARAO, PRIMARY_COLOR_EG, SECONDARY_COLOR_EG);

        spawnEgg("shieldmaidenegg", () -> ModEntities.SHIELDMAIDEN, PRIMARY_COLOR_EG, SECONDARY_COLOR_EG);
        spawnEgg("norsemenarcheregg", () -> ModEntities.NORSEMEN_ARCHER, PRIMARY_COLOR_EG, SECONDARY_COLOR_EG);
        spawnEgg("norsemenchiefegg", () -> ModEntities.NORSEMEN_CHIEF, PRIMARY_COLOR_EG, SECONDARY_COLOR_EG);

        spawnEgg("amazonegg", () -> ModEntities.AMAZON, PRIMARY_COLOR_EG, SECONDARY_COLOR_EG);
        spawnEgg("amazonspearmanegg", () -> ModEntities.AMAZONSPEARMAN, PRIMARY_COLOR_EG, SECONDARY_COLOR_EG);
        spawnEgg("amazonchiefegg", () -> ModEntities.AMAZONCHIEF, PRIMARY_COLOR_EG, SECONDARY_COLOR_EG);

        spawnEgg("mercegg", () -> ModEntities.MERCENARY, PRIMARY_COLOR_MERC, SECONDARY_COLOR_MERC);
    }
