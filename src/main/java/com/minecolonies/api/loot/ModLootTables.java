...
public final class ModLootTables
{
    ...
    public static final ResourceKey<LootTable> FISHING_FISH = ResourceKey.create(Registries.LOOT_TABLE, Identifier.parse(FISHERMAN_ID + "/fish"));

    /** Fisherman secondary junk table */
    public static final ResourceKey<LootTable> FISHING_JUNK = ResourceKey.create(Registries.LOOT_TABLE, Identifier.parse(FISHERMAN_ID + "/junk"));

    /** Fisherman secondary treasure table */
    public static final ResourceKey<LootTable> FISHING_TREASURE = ResourceKey.create(Registries.LOOT_TABLE, Identifier.parse(FISHERMAN_ID + "/treasure"));
    ...
    private static Map<Integer, ResourceKey<LootTable>> createFishermanBonusMap()
    {
        ...
        {
            map.put(level, ResourceKey.create(Registries.LOOT_TABLE, Identifier.parse(FISHERMAN_ID + "/bonus" + level)));
        }
