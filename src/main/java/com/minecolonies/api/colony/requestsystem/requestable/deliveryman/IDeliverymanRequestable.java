...
public interface IDeliverymanRequestable extends IRequestable
{
    ...
    /**
     * This will increment the priority due to the aging algorithm. This is important because it prevents starvation, making older requests successively more important.
     */
