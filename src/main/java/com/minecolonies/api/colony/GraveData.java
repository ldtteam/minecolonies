...
public class GraveData implements IGraveData
{
    ...
    {
        citizenDataNBT  = compound.contains(TAG_CITIZEN_NBT) ? compound.getCompoundOrEmpty(TAG_CITIZEN_NBT) : null;
        citizenName     = compound.contains(TAG_CITIZEN_NAME) ? compound.getStringOr(TAG_CITIZEN_NAME, "") : null;
        citizenJobName  = compound.contains(TAG_CITIZEN_JOB_NAME) ? compound.getStringOr(TAG_CITIZEN_JOB_NAME, "") : null;
    }
