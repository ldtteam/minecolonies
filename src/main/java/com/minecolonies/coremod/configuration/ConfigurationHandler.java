...
public final class ConfigurationHandler
{
    ...
    public static synchronized void init(final File file)
    {
        ...
        try
        {
            ...
            builderBuildBlockDelay =
              config.get(CATEGORY_GAMEPLAY, "builderBuildBlockDelay", builderBuildBlockDelay, "How many tick between placing blocks for the builder?").getInt();
            blockMiningDelayModifier = config.get(CATEGORY_GAMEPLAY,
              "blockMiningDelayModifier",
              blockMiningDelayModifier,
            ...
            turnOffExplosionsInColonies =
              config.get(CATEGORY_GAMEPLAY, "turnOffExplosionsInColonies", turnOffExplosionsInColonies, "Turn off explosions inside the colonies radius?").getBoolean();
