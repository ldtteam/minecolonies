...
public class WindowScan extends AbstractWindowSkeleton
{
    ...
    {
        super.onOpened();
        findPaneOfTypeByID(POS1X_LABEL, TextField.class).setText(String.valueOf(pos1.getX()));
        findPaneOfTypeByID(POS1Y_LABEL, TextField.class).setText(String.valueOf(pos1.getY()));
        findPaneOfTypeByID(POS1Z_LABEL, TextField.class).setText(String.valueOf(pos1.getZ()));

        findPaneOfTypeByID(POS2X_LABEL, TextField.class).setText(String.valueOf(pos2.getX()));
        findPaneOfTypeByID(POS2Y_LABEL, TextField.class).setText(String.valueOf(pos2.getY()));
        findPaneOfTypeByID(POS2Z_LABEL, TextField.class).setText(String.valueOf(pos2.getZ()));
    }
    ...
    private void confirmClicked()
    {
        ...
        final int x1 = Integer.parseInt(findPaneOfTypeByID(POS1X_LABEL, TextField.class).getText());
        final int y1 = Integer.parseInt(findPaneOfTypeByID(POS1Y_LABEL, TextField.class).getText());
        final int z1 = Integer.parseInt(findPaneOfTypeByID(POS1Z_LABEL, TextField.class).getText());

        final int x2 = Integer.parseInt(findPaneOfTypeByID(POS2X_LABEL, TextField.class).getText());
        final int y2 = Integer.parseInt(findPaneOfTypeByID(POS2Y_LABEL, TextField.class).getText());
        final int z2 = Integer.parseInt(findPaneOfTypeByID(POS2Z_LABEL, TextField.class).getText());
