...
public class WindowFurnaceCrafting extends ContainerScreen<ContainerCraftingFurnace>
{
     ...
     */
    public WindowFurnaceCrafting(final ContainerCraftingFurnace container,
        final PlayerInventory playerInventory,
        final ITextComponent iTextComponent)
    {
        super(container, playerInventory, iTextComponent);
        this.container = container;
        this.building = (AbstractBuildingSmelterCrafter.View) IColonyManager.getInstance()
    ...
    protected void init()
    {
        ...
        final Button doneButton = new Button(guiLeft
            + BUTTON_X_OFFSET, guiTop + BUTTON_Y_POS, BUTTON_WIDTH, BUTTON_HEIGHT, buttonDisplay, new OnButtonPress());
