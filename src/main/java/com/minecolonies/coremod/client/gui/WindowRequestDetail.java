...
public class WindowRequestDetail extends BOWindow implements ButtonHandler
{
    ...
    public void onOpened()
    {
        ...
        else
        {
            ...
            findPaneOfTypeByID(REQUEST_SHORT_DETAIL, Text.class).setText(new TextComponent(request.getLongDisplayString().getString().replace("§f", "")).withStyle(ChatFormatting.BLACK));
        }
