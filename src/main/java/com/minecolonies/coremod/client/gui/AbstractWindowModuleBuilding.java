...
public abstract class AbstractWindowModuleBuilding<B extends IBuildingView> extends AbstractModuleWindow
{
    ...
    public AbstractWindowModuleBuilding(final B building, final String resource)
    {
        ...
        if (buttonInfo != null)
        {
            buttonInfo.setVisible(I18n.exists(PARTIAL_INFO_TEXT + building.getSchematicName() + ".0"));
        }
    }
    ...
    {
        String buttonLabel =
          buttonBuild.getText() instanceof TranslationTextComponent ? ((TranslationTextComponent) buttonBuild.getText()).getKey() : buttonBuild.getTextAsString();
