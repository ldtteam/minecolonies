 ...
 */
public class WindowHutStoneSmelterModule extends AbstractWindowWorkerModuleBuilding<BuildingStoneSmeltery.View>
{
    /**
     * The resource string.
     */
     ...
     */
    public WindowHutStoneSmelterModule(final BuildingStoneSmeltery.View building)
    {
