...
public class PathfindingDebugRenderer
{
    ...
    private static void renderDebugText(@NotNull final MNode n, final WorldEventContext ctx)
    {
        ...
        fontrenderer.drawInBatch(s1, -fontrenderer.width(s1) / 2.0f, 1, 0xFFFFFFFF, false, mat, ctx.getBufferSource(), false, 0, 15728880);
        ctx.getPoseStack().translate(0.0F, 8F, -0.1F);
        fontrenderer.drawInBatch(s2, -fontrenderer.width(s2) / 2.0f, 1, 0xFFFFFFFF, false, mat, ctx.getBufferSource(), false, 0, 15728880);
