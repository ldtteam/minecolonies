...
/**
 * A simple layer renderer for modular citizen clothing layers.
 */
public class ClothLayer extends AbstractCitizenLayer
{
    public ClothLayer(IEntityRenderer<AbstractEntityCitizen, ModularCitizenModel> rendererIn) {
        super(rendererIn);
    }
      ...
      final float headPitch)
    {
        ...
        {
            final ModularCitizenModel model = entityCitizen.getRenderSettings().modelsCloth.get(slot);
            final ResourceLocation texture = entityCitizen.getRenderSettings().texturesCloth.get(slot);
