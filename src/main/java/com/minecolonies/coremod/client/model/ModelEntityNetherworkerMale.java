...
public class ModelEntityNetherworkerMale extends CitizenModel<AbstractEntityCitizen>  
{

	public ModelEntityNetherworkerMale() 
	{
		...
		body.texOffs(15, 32).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, 0.25F, false);
