...
{
  public ModelEntityConcreteMixerMale(final ModelPart part)
  {
      super(part);
      hat.visible = false;
  ...
  public static LayerDefinition createMesh()
  {
      ...
      PartDefinition hairDefinition = headDefinition.addOrReplaceChild("hair",
        CubeListBuilder.create()
          ...
          .texOffs(33, 46).addBox(-4.25F, -32.25F, 4.02F, 8.5F, 7.35F, 0.25F).mirror()
          ...
          .texOffs(16, 56).addBox(-4.45F, -26.0F, 1.02F, 0.45F, 1.1F, 1.0F)
          .texOffs(12, 56).addBox(4.0F, -26.0F, 1.02F, 0.45F, 1.1F, 1.0F)
          ...
          .texOffs(26, 46).addBox(4.0F, -26.0F, 2.02F, 0.35F, 1.1F, 2.0F)
          .texOffs(24, 49).addBox(-4.35F, -26.0F, 2.02F, 0.35F, 1.1F, 2.0F).mirror()
