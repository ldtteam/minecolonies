...
public class ModelEntityCookMale extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public ModelEntityCookMale(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition prismDefinition = rightLegDefinition.addOrReplaceChild("prism",
          CubeListBuilder.create()
            .texOffs(0, 0).addBox(2.0F, -12.0F, 0.0F, 3.0F, 1.0F, 1.0F).mirror()
          , PartPose.offset(-3.0F, 11.0F, 2.0F));

        PartDefinition planeDefinition = rightLegDefinition.addOrReplaceChild("plane",
          CubeListBuilder.create()
            .texOffs(0, 2).addBox(2.0F, -12.0F, 0.0F, 3.0F, 4.0F, 0.0F).mirror()
