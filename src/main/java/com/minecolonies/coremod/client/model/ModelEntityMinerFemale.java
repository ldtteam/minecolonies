...
public class ModelEntityMinerFemale extends CitizenModel
{
    //fields
    RendererModel goggleLeft;
    RendererModel goggleBase;
    RendererModel goggleRight;
    RendererModel goggleRightLens;
    RendererModel goggleLeftLens;
    RendererModel chest;
    RendererModel helmetBase;
    RendererModel helmetLight;
    RendererModel helmetFront;
    RendererModel helmetTop;
    RendererModel helmetMiddle;
    RendererModel bag;
    RendererModel belt;
    RendererModel torch;
    RendererModel bagLock;
    RendererModel beltBuckle;
    ...
    public ModelEntityMinerFemale()
    {
        ...
        chest = new RendererModel(this, 0, 55);
        ...
        goggleLeft = new RendererModel(this, 20, 39);
        goggleLeft.addBox(1F, -5F, -4.5F, 2, 2, 1);
        ...
        goggleBase = new RendererModel(this, 0, 33);
        goggleBase.addBox(-4.5F, -4.9F, -4.35F, 9, 1, 4);
        ...
        goggleRight = new RendererModel(this, 0, 39);
        goggleRight.addBox(-3F, -5F, -4.5F, 2, 2, 1);
        ...
        goggleRightLens = new RendererModel(this, 7, 39);
        goggleRightLens.addBox(-2.3F, -4.5F, -4.6F, 1, 1, 1);
        ...
        goggleLeftLens = new RendererModel(this, 15, 39);
        goggleLeftLens.addBox(1.3F, -4.5F, -4.6F, 1, 1, 1);
        ...
        helmetBase = new RendererModel(this, 32, 49);
        ...
        helmetFront = new RendererModel(this, 1, 43);
        ...
        helmetLight = new RendererModel(this, 23, 54);
        helmetLight.addBox(-1F, -8F, -6F, 2, 2, 2);
        ...
        helmetMiddle = new RendererModel(this, 32, 41);
        helmetMiddle.addBox(-4.5F, -8.5F, -3.5F, 9, 1, 6);
        ...
        belt = new RendererModel(this, 57, 22);
        ...
        torch = new RendererModel(this, 57, 29);
        ...
        bagLock = new RendererModel(this, 68, 16);
        bagLock.addBox(-2.5F, 8F, 1.5F, 2, 1, 1);
        bagLock.setRotationPoint(0F, 0F, 0F);
        bagLock.setTextureSize(128, 64);
        bagLock.mirror = true;
        setRotation(bagLock, 0F, 0F, 0F);

        beltBuckle = new RendererModel(this, 68, 29);
        beltBuckle.addBox(-1F, 9F, -2.7F, 2, 2, 1);
        ...
        ponytailBase = new RendererModel(this, 80, 40);
        ponytailBase.addBox(-0.5F, 2.4F, 3.7F, 1, 5, 1);
        ...
        ponytailTail = new RendererModel(this, 79, 33);
        ponytailTail.addBox(-1F, -2F, 3.4F, 2, 5, 1);
