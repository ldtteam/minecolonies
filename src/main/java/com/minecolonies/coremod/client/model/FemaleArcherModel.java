...
import static com.minecolonies.coremod.entity.ai.citizen.guard.EntityAIRanger.RENDER_META_ARROW;
...
public class FemaleArcherModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition quiver = bipedBody.addOrReplaceChild("quiver", CubeListBuilder.create().texOffs(71, 20).addBox(-0.979F, -4.9528F, -1.25F, 3.0F, 14.0F, 0.0F, new CubeDeformation(0.05F))
          ...
          .texOffs(55, 19).addBox(-1.0F, -1.0F, -2.0F, 3.0F, 14.0F, 1.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(-4.9F, 2.0F, 4.0F, 0.0F, 0.0F, -0.6109F));
