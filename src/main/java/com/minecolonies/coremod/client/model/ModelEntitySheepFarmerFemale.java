...
public class ModelEntitySheepFarmerFemale extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public ModelEntitySheepFarmerFemale(final ModelPart part)
    {
        super(part);
        hat.visible = false;

        IMinecoloniesAPI.getInstance().getModelTypeRegistry().register(BipedModelType.SHEEP_FARMER, true, this);
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition hairDefinition = headDefinition.addOrReplaceChild("hair",
          CubeListBuilder.create()
            ...
            .texOffs(17, 35).addBox(3.5F, -0.5F, 2.5F, 1.0F, 2.0F, 2.0F).mirror()
            .texOffs(30, 32).addBox(2.5F, -3.5F, 1.5F, 2.0F, 4.0F, 3.0F).mirror()
            .texOffs(15, 32).addBox(-1.5F, -7.5F, -4.5F, 4.0F, 1.0F, 1.0F).mirror()
            .texOffs(58, 51).addBox(-3.5F, -0.5F, 3.5F, 7.0F, 3.0F, 1.0F).mirror()
            .texOffs(1, 54).addBox(-4.5F, -0.5F, 2.5F, 1.0F, 2.0F, 2.0F).mirror()
        ...
        PartDefinition ponytail_1Definition = hairDefinition.addOrReplaceChild("ponytail_1",
          CubeListBuilder.create()
            .texOffs(66, 57).addBox(-7.5F, -7.5F, -4.5F, 1.0F, 1.0F, 4.0F).mirror()
          , PartPose.offsetAndRotation(7.0F, 5.5F, 2.0F, -1.1868F, 0.0F, 0.0F));

        PartDefinition ponytail_2Definition = hairDefinition.addOrReplaceChild("ponytail_2",
          CubeListBuilder.create()
            .texOffs(26, 53).addBox(-7.5F, -7.5F, -4.5F, 3.0F, 2.0F, 4.0F).mirror()
        ...
        PartDefinition ponytail_3Definition = hairDefinition.addOrReplaceChild("ponytail_3",
          CubeListBuilder.create()
            .texOffs(47, 56).addBox(-7.5F, -7.5F, -4.5F, 2.0F, 2.0F, 4.0F).mirror()
          , PartPose.offsetAndRotation(6.5F, 2.0F, 1.0F, -1.1868F, 0.0F, 0.0F));
        ...
        PartDefinition bagRDefinition = bodyDefinition.addOrReplaceChild("bagR",
          CubeListBuilder.create()
            .texOffs(56, 17).addBox(3.0F, 0.0F, 3.0F, 1.0F, 9.0F, 3.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bagLDefinition = bodyDefinition.addOrReplaceChild("bagL",
          CubeListBuilder.create()
            .texOffs(64, 17).addBox(-4.0F, 0.0F, 3.0F, 1.0F, 9.0F, 3.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bagBackDefinition = bodyDefinition.addOrReplaceChild("bagBack",
          CubeListBuilder.create()
            .texOffs(72, 17).addBox(-3.0F, 0.0F, 2.0F, 6.0F, 9.0F, 1.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bagFrontDefinition = bodyDefinition.addOrReplaceChild("bagFront",
          CubeListBuilder.create()
            .texOffs(86, 17).addBox(-3.0F, 1.0F, 6.0F, 6.0F, 8.0F, 1.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bagWheatDefinition = bodyDefinition.addOrReplaceChild("bagWheat",
          CubeListBuilder.create()
            .texOffs(58, 40).addBox(-3.0F, 1.5F, 3.0F, 6.0F, 1.0F, 3.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bagBotDefinition = bodyDefinition.addOrReplaceChild("bagBot",
          CubeListBuilder.create()
            .texOffs(70, 28).addBox(-3.0F, 9.0F, 3.0F, 6.0F, 1.0F, 3.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bipedChestDefinition = bodyDefinition.addOrReplaceChild("bipedChest",
          CubeListBuilder.create()
            .texOffs(40, 32).addBox(-3.5F, 2.7F, -0.5F, 7.0F, 3.0F, 4.0F).mirror()
