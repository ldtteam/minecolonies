...
public class ModelEntityBaseMale extends CitizenModel
{
    public ModelEntityBaseMale(final int... xYSize)
    {
        if(xYSize.length == 2)
        {
            this.textureWidth = xYSize[0];
            this.textureHeight = xYSize[1];
        }
        ...
        bipedLeftArm.setTextureOffset(32, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, true);
