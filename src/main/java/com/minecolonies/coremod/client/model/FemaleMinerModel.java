...
public class FemaleMinerModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition HairExtension = bipedHead.addOrReplaceChild("HairExtension", CubeListBuilder.create(), PartPose.offset(0.0F, 1.0F, 0.0F));

        PartDefinition Ponytail = bipedHead.addOrReplaceChild("Ponytail", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -4.5403F, 4.0061F, 0.2182F, 0.0F, 0.0F));
        ...
        PartDefinition backpack = bipedBody.addOrReplaceChild("backpack", CubeListBuilder.create().texOffs(104, 52).addBox(-4.0F, -2.7F, 0.0F, 8.0F, 8.0F, 4.0F, new CubeDeformation(0.3F))
        ...
        PartDefinition torch2_r1 = backpack.addOrReplaceChild("torch2_r1", CubeListBuilder.create().texOffs(107, 39).addBox(-0.5F, -2.3F, 0.1F, 1.0F, 6.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-4.9F, -0.8F, 1.7F, -0.0436F, 0.0F, 0.0F));

        PartDefinition torch1_r1 = backpack.addOrReplaceChild("torch1_r1", CubeListBuilder.create().texOffs(103, 39).addBox(-0.5F, -3.0F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-4.9F, -0.8F, 1.7F, 0.0873F, 0.0F, 0.0F));
    ...
    public void setupAnim(@NotNull final AbstractEntityCitizen entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
        ...
        backpack.getChild("torch2_r1").visible = entity.getRenderMetadata().contains(RENDER_META_TORCH);
        backpack.getChild("torch1_r1").visible = entity.getRenderMetadata().contains(RENDER_META_TORCH);
