...
public class MaleKnightModel extends CitizenModel<AbstractEntityCitizen>
{

    public MaleKnightModel(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition FancyHat = bipedHead.addOrReplaceChild("FancyHat", CubeListBuilder.create().texOffs(96, 0).addBox(-4.0F, -1.9525F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.6F))
          ...
          .texOffs(102, 25).addBox(-5.0F, -0.3625F, 5.0F, 10.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1F, -6.2375F, 0.0F, 0.0F, -0.0175F, -0.0436F));

        PartDefinition feather2_r1 = FancyHat.addOrReplaceChild("feather2_r1", CubeListBuilder.create().texOffs(92, 29).addBox(-0.6F, -6.3F, -1.2F, 0.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.4F, -1.1125F, 1.318F, -0.1858F, -0.528F, -0.0543F));
