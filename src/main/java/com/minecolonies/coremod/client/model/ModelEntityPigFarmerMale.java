...
public class ModelEntityPigFarmerMale extends CitizenModel
{
    public ModelEntityPigFarmerMale()
    {
        ...
        carrot4 = new RendererModel(this, 6, 33);
        ...
        strapR = new RendererModel(this, 0, 36);
        ...
        strapL = new RendererModel(this, 10, 36);
        ...
        carrotBase = new RendererModel(this, 0, 49);
        ...
        carrot1 = new RendererModel(this, 0, 33);
        ...
        carrot2 = new RendererModel(this, 2, 33);
        ...
        carrot3 = new RendererModel(this, 4, 33);
