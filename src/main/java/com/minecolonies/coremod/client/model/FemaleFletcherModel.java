...
public class FemaleFletcherModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition dress = bipedBody.addOrReplaceChild("dress", CubeListBuilder.create().texOffs(64, 30).addBox(-5.0F, -11.0F, -4.0F, 10.0F, 9.0F, 9.0F, new CubeDeformation(0.0F))
