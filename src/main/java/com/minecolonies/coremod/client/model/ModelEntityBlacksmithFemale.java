...
public class ModelEntityBlacksmithFemale extends CitizenModel<AbstractEntityCitizen>
{
    public ModelEntityBlacksmithFemale()
    {
		...
		bipedRightArm.setTextureOffset(40, 16).addBox(-3.0F, 0.0F, -2.0F, 4.0F, 10.0F, 4.0F, 0.0F, false);

		bipedLeftArm = new ModelRenderer(this);
		bipedLeftArm.setRotationPoint(5.0F, 6.0F, 0.0F);
		bipedLeftArm.setTextureOffset(40, 16).addBox(-1.0F, 0.0F, -2.0F, 4.0F, 10.0F, 4.0F, 0.0F, true);

		bipedRightLeg = new ModelRenderer(this);
		bipedRightLeg.setRotationPoint(-2.0F, 14.0F, 0.0F);
		bipedRightLeg.setTextureOffset(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 4.0F, 0.0F, false);

		bipedLeftLeg = new ModelRenderer(this);
		bipedLeftLeg.setRotationPoint(2.0F, 14.0F, 0.0F);
		bipedLeftLeg.setTextureOffset(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 4.0F, 0.0F, true);

		bipedHead = new ModelRenderer(this);
		bipedHead.setRotationPoint(0.0F, 4.0F, 0.0F);
		bipedHead.setTextureOffset(0, 0).addBox(-4.0F, -6.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, true);

		headdetail = new ModelRenderer(this);
		headdetail.setRotationPoint(0.0F, 20.0F, 0.0F);
		bipedHead.addChild(headdetail);
		headdetail.setTextureOffset(32, 0).addBox(-4.0F, -26.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.5F, false);
