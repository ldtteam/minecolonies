...
public class MaleBlacksmithModel extends CitizenModel<AbstractEntityCitizen>
{

    public MaleBlacksmithModel(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition Beard = bipedHead.addOrReplaceChild("Beard", CubeListBuilder.create().texOffs(56, 0).addBox(-4.0F, -1.0F, 3.0F, 8.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
