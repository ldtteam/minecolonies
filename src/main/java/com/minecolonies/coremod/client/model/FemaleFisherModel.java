...
import static com.minecolonies.coremod.entity.ai.citizen.fisherman.EntityAIWorkFisherman.RENDER_META_FISH;
...
public class FemaleFisherModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition lures = bipedBody.addOrReplaceChild("lures", CubeListBuilder.create().texOffs(108, 25).addBox(-5.0F, 0.0F, -3.41F, 5.0F, 5.0F, 2.0F, new CubeDeformation(-1.0F))
          ...
          .texOffs(108, 39).addBox(-1.0F, 4.0F, -3.45F, 5.0F, 5.0F, 2.0F, new CubeDeformation(-1.0F)), PartPose.offset(0.5F, 4.0F, 0.0F));
