...
public class ModelEntityBeekeeperMale extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public ModelEntityBeekeeperMale()
    {
        ...
        bipedLeftArm.setTextureOffset(38, 50).addBox(-1.25F, 6.0F, -2.25F, 4.5F, 0.5F, 4.5F, 0.0F, false);
        ...
        bipedRightArm.setTextureOffset(38, 42).addBox(-3.25F, 6.0F, -2.25F, 4.5F, 0.5F, 4.5F, 0.0F, false);
        ...
        hatBottom.setTextureOffset(57, 25).addBox(-5.5F, -5.4856F, -5.457F, 11.25F, 1.0F, 10.0F, 0.0F, true);
        ...
        hatTop.setTextureOffset(64, 3).addBox(-3.5F, -9.0358F, -2.9483F, 7.0F, 1.0F, 5.0F, 0.0F, true);
        ...
        hatRight.setTextureOffset(81, 40).addBox(-5.5F, -4.3454F, 1.5018F, 11.0F, 5.0F, 1.0F, 0.0F, true);
        hatRight.setTextureOffset(58, 46).addBox(4.5F, -4.4159F, -6.4558F, 1.0F, 5.0F, 8.0F, 0.0F, true);
        hatRight.setTextureOffset(76, 46).addBox(-5.5F, -4.4159F, -6.4558F, 1.0F, 5.0F, 8.0F, 0.0F, true);
        hatRight.setTextureOffset(57, 40).addBox(-5.5F, -4.4849F, -7.5006F, 11.0F, 5.0F, 1.0F, 0.0F, true);
        ...
        hatNeck.setTextureOffset(92, 8).addBox(-4.5F, -6.7F, -2.7F, 0.75F, 7.75F, 1.0F, 0.0F, true);
        hatNeck.setTextureOffset(97, 8).addBox(3.5F, -6.7F, -2.7F, 0.75F, 7.75F, 1.0F, 0.0F, true);
        hatNeck.setTextureOffset(92, 17).addBox(-4.5F, 1.05F, -2.7F, 8.75F, 0.75F, 1.0F, 0.0F, true);
        ...
        hatM.setTextureOffset(58, 11).addBox(-4.75F, -8.3358F, -4.6983F, 9.5F, 3.0F, 8.6F, 0.0F, true);
