...
public class ModelEntityPigFarmerFemale extends CitizenModel<AbstractEntityCitizen> {
	...
	bipedChestModelRenderer hair;
	bipedChestModelRenderer left_top_1;
	bipedChestModelRenderer backhair;
	bipedChestModelRenderer hairbackTop_2;
	bipedChestModelRenderer hairbackTop_3;
	bipedChestModelRenderer hairBackTop_4;
	bipedChestModelRenderer hairTop_1;
	bipedChestModelRenderer hairTop_2;
	bipedChestModelRenderer hairLeftTop_1;
	bipedChestModelRenderer hairLeftTop_2;
	bipedChestModelRenderer hairLeftTop_3;
	bipedChestModelRenderer hairLeftTop_4;
	bipedChestModelRenderer hairLeftTop_5;
	bipedChestModelRenderer hairbackbuttom1;
	bipedChestModelRenderer ponytail_1;
	bipedChestModelRenderer ponytail_2;
	bipedChestModelRenderer ponytail_3;
	bipedChestModelRenderer hairRightTop_1;
	bipedChestModelRenderer hairfrontTop_1;
	bipedChestModelRenderer hairfrontTop_2;
	bipedChestModelRenderer hairfrontTop_3;
	bipedChestModelRenderer bipedRightLeg;
	bipedChestModelRenderer carrot1;
	bipedChestModelRenderer carrot2;
	bipedChestModelRenderer carrot3;
	bipedChestModelRenderer carrot4;
	bipedChestModelRenderer base;
	bipedChestModelRenderer strapL;
	bipedChestModelRenderer strapR;
