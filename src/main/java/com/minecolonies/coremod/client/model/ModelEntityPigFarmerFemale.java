...
public class ModelEntityPigFarmerFemale extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public ModelEntityPigFarmerFemale(final ModelPart part)
    {
        super(part);
        hat.visible = false;

        IMinecoloniesAPI.getInstance().getModelTypeRegistry().register(BipedModelType.PIG_FARMER, true, this);
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition carrot1Definition = bodyDefinition.addOrReplaceChild("carrot1",
          CubeListBuilder.create()
            .texOffs(46, 39).addBox(-2.5F, 6.0F, -1.5F, 1.0F, 3.0F, 0.0F).mirror()
        ...
        PartDefinition carrot2Definition = bodyDefinition.addOrReplaceChild("carrot2",
          CubeListBuilder.create()
            .texOffs(46, 39).addBox(0.5F, 6.0F, -2.5F, 1.0F, 3.0F, 0.0F).mirror()
        ...
        PartDefinition carrot3Definition = bodyDefinition.addOrReplaceChild("carrot3",
          CubeListBuilder.create()
            .texOffs(46, 39).addBox(1.0F, 6.0F, -2.5F, 1.0F, 3.0F, 0.0F).mirror()
        ...
        PartDefinition carrot4Definition = bodyDefinition.addOrReplaceChild("carrot4",
          CubeListBuilder.create()
            .texOffs(46, 39).addBox(0.0F, 6.5F, -2.5F, 1.0F, 3.0F, 0.0F).mirror()
        ...
        PartDefinition baseDefinition = bodyDefinition.addOrReplaceChild("base",
          CubeListBuilder.create()
            .texOffs(63, 32).addBox(-3.5F, 8.0F, -3.5F, 8.0F, 3.0F, 4.0F).mirror()
          , PartPose.offset(-0.5F, 0.0F, 0.0F));

        PartDefinition strapLDefinition = bodyDefinition.addOrReplaceChild("strapL",
          CubeListBuilder.create()
            .texOffs(67, 18).addBox(2.8F, 0.01F, -2.5F, 1.0F, 9.0F, 4.0F).mirror()
          , PartPose.offsetAndRotation(0.5F, 0.0F, 0.0F, -0.0698F, 0.0F, 0.0F));

        PartDefinition strapRDefinition = bodyDefinition.addOrReplaceChild("strapR",
          CubeListBuilder.create()
            .texOffs(57, 18).addBox(-3.8F, 0.01F, -2.5F, 1.0F, 9.0F, 4.0F).mirror()
          , PartPose.offsetAndRotation(-0.5F, 0.0F, 0.0F, -0.0698F, 0.0F, 0.0F));
