...
public class ModelEntityUndertakerMale extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public ModelEntityUndertakerMale(final ModelPart part)
    {
        super(part);
        hat.visible = false;

        IMinecoloniesAPI.getInstance().getModelTypeRegistry().register(BipedModelType.UNDERTAKER, false, this);
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition hatPieceDefinition = headDefinition.addOrReplaceChild("hatPiece",
          CubeListBuilder.create()
            .texOffs(64, 0).addBox(-3.9664F, -3.1854F, -5.0F, 8.0F, 2.0F, 10.0F)
            .texOffs(90, 0).addBox(-2.9664F, -10.6F, -3.0F, 6.0F, 1.0F, 6.0F)
            ...
            .texOffs(78, 12).addBox(-2.9664F, -11.3F, 3.0F, 6.0F, 10.0F, 1.0F, new CubeDeformation(-0.1F))
          , PartPose.offsetAndRotation(0.0F, -5.6F, 0.0F, -0.0611F, 0.0F, 0.0F));

        PartDefinition hatPartLowLeftDefinition = hatPieceDefinition.addOrReplaceChild("hatPartLowLeft",
          CubeListBuilder.create()
            .texOffs(92, 7).addBox(-2.3F, -0.7F, -5.0F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.01F))
          , PartPose.offsetAndRotation(-3.1F, -2.2F, 0.0F, 0.0F, 0.0F, 0.48F));

        PartDefinition hatPartLowRightDefinition = hatPieceDefinition.addOrReplaceChild("hatPartLowRight",
          CubeListBuilder.create()
            .texOffs(96, 19).addBox(0.4466F, 1.4993F, -5.0F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.01F))
