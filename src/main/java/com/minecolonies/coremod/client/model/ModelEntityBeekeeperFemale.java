...
public class ModelEntityBeekeeperFemale extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public ModelEntityBeekeeperFemale(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition chestDefinition = bodyDefinition.addOrReplaceChild("chest",
          CubeListBuilder.create()
            .texOffs(17, 33).addBox(-5.0F, -1.0F, -2.0F, 6.0F, 3.0F, 3.0F)
          , PartPose.offsetAndRotation(2.0F, 3.0F, -2.0F, 0.6109F, 0.0F, 0.0F));
        ...
        PartDefinition rightArmDefinition = partDefinition.addOrReplaceChild("right_arm",
          CubeListBuilder.create()
            ...
            .texOffs(38, 41).addBox(-3.25F, 6.0F, -2.25F, 4.5F, 0.5F, 4.5F)
          , PartPose.offset(-5.0F, 2.0F, 0.0F));
        ...
        PartDefinition hatBottomDefinition = headDefinition.addOrReplaceChild("hatBottom",
          CubeListBuilder.create()
            .texOffs(57, 26).addBox(-5.5F, -5.4856F, -5.457F, 11.25F, 1.0F, 10.0F).mirror()
        ...
        PartDefinition hatTopDefinition = headDefinition.addOrReplaceChild("hatTop",
          CubeListBuilder.create()
            .texOffs(64, 4).addBox(-3.5F, -9.0358F, -2.9483F, 7.0F, 1.0F, 5.0F).mirror()
          , PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0349F, 0.0F, 0.0F));

        PartDefinition hatRightDefinition = headDefinition.addOrReplaceChild("hatRight",
          CubeListBuilder.create()
            .texOffs(81, 41).addBox(-5.5F, -4.3454F, 1.5018F, 11.0F, 5.0F, 1.0F).mirror()
            .texOffs(58, 47).addBox(4.5F, -4.4159F, -6.4558F, 1.0F, 5.0F, 8.0F).mirror()
            .texOffs(75, 47).addBox(-5.5F, -4.4159F, -6.4558F, 1.0F, 5.0F, 8.0F).mirror()
            .texOffs(57, 41).addBox(-5.5F, -4.4849F, -7.5006F, 11.0F, 5.0F, 1.0F).mirror()
        ...
        PartDefinition hatNeckDefinition = headDefinition.addOrReplaceChild("hatNeck",
          CubeListBuilder.create()
            .texOffs(98, 14).addBox(-4.5F, -6.7F, -2.7F, 0.75F, 7.75F, 1.0F).mirror()
            .texOffs(98, 14).addBox(3.5F, -6.7F, -2.7F, 0.75F, 7.75F, 1.0F).mirror()
            .texOffs(98, 14).addBox(-4.5F, 1.05F, -2.7F, 8.75F, 0.75F, 1.0F).mirror()
        ...
        PartDefinition hatMDefinition = headDefinition.addOrReplaceChild("hatM",
          CubeListBuilder.create()
            .texOffs(58, 13).addBox(-4.75F, -8.3358F, -4.6983F, 9.5F, 3.0F, 8.5F).mirror()
          , PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0349F, 0.0F, 0.0F));
