...
public class ModelEntityBeekeeperFemale extends CitizenModel<AbstractEntityCitizen> {
	...
	public ModelEntityBeekeeperFemale() {
	 ...
	 ModelRenderer hatM;
		...
		chest.setTextureOffset(17, 33).addBox(-5.0F, -1.0F, -2.0F, 6.0F, 3.0F, 3.0F, 0.0F, false);
		...
		bipedRightArm.setTextureOffset(38, 41).addBox(-3.25F, 6.0F, -2.25F, 4.5F, 0.5F, 4.5F, 0.0F, false);
		...
		hatBottom.setTextureOffset(57, 26).addBox(-5.5F, -5.4856F, -5.457F, 11.25F, 1.0F, 10.0F, 0.0F, true);
		...
		hatTop.setTextureOffset(64, 4).addBox(-3.5F, -9.0358F, -2.9483F, 7.0F, 1.0F, 5.0F, 0.0F, true);
		...
		hatRight.setTextureOffset(81, 41).addBox(-5.5F, -4.3454F, 1.5018F, 11.0F, 5.0F, 1.0F, 0.0F, true);
		hatRight.setTextureOffset(58, 47).addBox(4.5F, -4.4159F, -6.4558F, 1.0F, 5.0F, 8.0F, 0.0F, true);
		hatRight.setTextureOffset(75, 47).addBox(-5.5F, -4.4159F, -6.4558F, 1.0F, 5.0F, 8.0F, 0.0F, true);
		hatRight.setTextureOffset(57, 41).addBox(-5.5F, -4.4849F, -7.5006F, 11.0F, 5.0F, 1.0F, 0.0F, true);
