...
public class FemaleAlchemistModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition HairExtensionDefinition = HeadDefinition.addOrReplaceChild("HairExtension",
          CubeListBuilder.create()
        ...
        PartDefinition ponyTailTip_r1Definition = PonytailDefinition.addOrReplaceChild("ponyTailTip_r1",
          CubeListBuilder.create()
            .texOffs(88, 55).addBox(0.0F, 0.0F, 0.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation( 0.1F))
          , PartPose.offset(-0.5F, -25.0F, 4.8F));

        PartDefinition ponytailBase_r1Definition = PonytailDefinition.addOrReplaceChild("ponytailBase_r1",
          CubeListBuilder.create()
            .texOffs(86, 48).addBox(0.0F, 0.0F, 0.0F, 2.0F, 5.0F, 2.0F)
          , PartPose.offset(-1.0F, -28.0F, 2.0F));
        ...
        PartDefinition glassesDefinition = HeadDefinition.addOrReplaceChild("glasses",
          CubeListBuilder.create()
            ...
            .texOffs(65, 30).addBox(2.8F, -0.9F, -2.89F, 2.0F, 2.0F, 5.0F, new CubeDeformation( -0.6F))
          , PartPose.offset(0.0F, -3.9F, -2.1F));
        ...
        PartDefinition Potion1Definition = BodyDefinition.addOrReplaceChild("Potion1",
          CubeListBuilder.create()
            ...
            .texOffs(61, 39).addBox(-1.4152F, 4.5465F, -1.4F, 5.0F, 4.0F, 5.0F, new CubeDeformation( -1.3F))
          , PartPose.offset(1.3F, 4.78F, -4.2F));
        ...
        PartDefinition capeShoulderRightDefinition = Right_ArmDefinition.addOrReplaceChild("capeShoulderRight",
          CubeListBuilder.create()
            .texOffs(112, 29).addBox(-1.0F, -1.0F, -2.5F, 3.0F, 2.0F, 5.0F, new CubeDeformation( 0.2F))
        ...
        PartDefinition capeShoulderLeftDefinition = Left_ArmDefinition.addOrReplaceChild("capeShoulderLeft",
          CubeListBuilder.create()
            .texOffs(96, 29).addBox(-2.0F, -1.0F, -2.5F, 3.0F, 2.0F, 5.0F, new CubeDeformation( 0.2F))
          , PartPose.offset(1.1F, -1.2F, 0.0F));
