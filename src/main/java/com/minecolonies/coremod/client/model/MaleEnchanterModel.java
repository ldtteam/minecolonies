...
public class MaleEnchanterModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition capeShoulderRight = bipedRightArm.addOrReplaceChild("capeShoulderRight", CubeListBuilder.create().texOffs(110, 29).addBox(-2.4F, -1.0F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.2F)), PartPose.offset(-1.1F, -1.2F, 0.0F));
        ...
        PartDefinition capeShoulderLeft = bipedLeftArm.addOrReplaceChild("capeShoulderLeft", CubeListBuilder.create().texOffs(92, 29).addBox(-2.0F, -1.0F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.2F)), PartPose.offset(1.1F, -1.2F, 0.0F));
