...
public class ModelEntityConcreteMixerFemale extends CitizenModel<AbstractEntityCitizen>
{
    public ModelEntityConcreteMixerFemale()
    {
        ...
        hair.setTextureOffset(70, 49).addBox(-4.35F, -26.0F, 3.02F, 0.35F, 6.0F, 1.0F, 0.0F, true);
        hair.setTextureOffset(74, 46).addBox(-4.25F, -25.0F, 1.02F, 0.25F, 3.25F, 2.0F, 0.0F, false);
        hair.setTextureOffset(28, 56).addBox(4.0F, -25.0F, 1.02F, 0.25F, 3.25F, 2.0F, 0.0F, false);
        hair.setTextureOffset(16, 56).addBox(-4.25F, -26.0F, 1.02F, 0.25F, 1.0F, 1.0F, 0.0F, false);
        hair.setTextureOffset(12, 56).addBox(4.0F, -26.0F, 1.02F, 0.25F, 1.0F, 1.0F, 0.0F, false);
        hair.setTextureOffset(29, 45).addBox(4.0F, -26.0F, 3.02F, 0.35F, 6.0F, 1.0F, 0.0F, false);
        ...
        hair.setTextureOffset(26, 46).addBox(4.0F, -26.0F, 2.02F, 0.35F, 1.0F, 1.0F, 0.0F, false);
        hair.setTextureOffset(24, 49).addBox(-4.35F, -26.0F, 2.02F, 0.35F, 1.0F, 1.0F, 0.0F, true);
        ...
        hair.setTextureOffset(33, 46).addBox(-4.25F, -32.25F, 4.02F, 8.5F, 6.75F, 0.25F, 0.0F, true);
        hair.setTextureOffset(74, 52).addBox(3.75F, -25.5F, 4.02F, 0.5F, 5.5F, 0.25F, 0.0F, true);
        hair.setTextureOffset(76, 52).addBox(-4.25F, -25.5F, 4.02F, 0.5F, 5.5F, 0.25F, 0.0F, true);
        hair.setTextureOffset(33, 54).addBox(-3.75F, -25.5F, 3.02F, 7.5F, 7.75F, 1.25F, 0.0F, true);
