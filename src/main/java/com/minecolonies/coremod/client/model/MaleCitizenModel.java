...
public class MaleCitizenModel extends CitizenModel<AbstractEntityCitizen>
{
    public MaleCitizenModel(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition SailorHat1 = bipedHead.addOrReplaceChild("SailorHat1", CubeListBuilder.create().texOffs(102, 0).addBox(-4.0F, 1.33F, -5.318F, 8.0F, 0.0F, 10.0F, new CubeDeformation(0.0F))
          ...
          .texOffs(88, 10).addBox(-3.0F, -2.05F, -3.218F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.55F, 0.318F, -0.1047F, 0.0F, 0.0F));
    ...
    public void setupAnim(@NotNull final AbstractEntityCitizen entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
        ...
        head.getChild("SailorHat1").visible = entity.getPose() != Pose.SLEEPING;
    }
}
