...
public class ModelEntityFletcherFemale extends CitizenModel<AbstractEntityCitizen>
{
    public ModelEntityFletcherFemale()
    {
        ...
        bipedBody.setTextureOffset(71, 16).addBox(-4.25F, 10.0F, -3.0F, 8.5F, 1.0F, 5.25F, 0.0F, true);
        ...
        chest.setTextureOffset(23, 19).addBox(-6.0F, -2.5179F, -10.5745F, 6.0F, 3.0F, 3.0F, 0.0F, false);
        ...
        bipedHead.setTextureOffset(0, 44).addBox(-4.25F, -8.0F, -0.25F, 0.25F, 5.5F, 4.25F, 0.0F, false);
        bipedHead.setTextureOffset(0, 46).addBox(4.0F, -8.0F, -1.5F, 0.25F, 5.75F, 5.5F, 0.0F, false);
        bipedHead.setTextureOffset(0, 44).addBox(-4.25F, -8.0F, -3.0F, 0.25F, 6.0F, 1.5F, 0.0F, false);
        bipedHead.setTextureOffset(0, 44).addBox(-4.25F, -8.0F, -1.5F, 0.25F, 6.75F, 1.25F, 0.0F, false);
        bipedHead.setTextureOffset(0, 44).addBox(4.0F, -8.0F, -3.0F, 0.25F, 5.25F, 1.5F, 0.0F, false);
        bipedHead.setTextureOffset(0, 44).addBox(-4.25F, -8.0F, -4.25F, 0.25F, 5.5F, 1.25F, 0.0F, false);
        bipedHead.setTextureOffset(0, 44).addBox(4.0F, -8.0F, -4.25F, 0.25F, 4.75F, 1.25F, 0.0F, false);
        bipedHead.setTextureOffset(0, 44).addBox(-4.25F, -2.5F, 1.75F, 0.25F, 3.75F, 2.25F, 0.0F, false);
        bipedHead.setTextureOffset(0, 44).addBox(4.0F, -2.25F, 1.75F, 0.25F, 3.75F, 2.25F, 0.0F, false);
        bipedHead.setTextureOffset(0, 44).addBox(-4.25F, -2.5F, -0.25F, 0.25F, 2.0F, 2.0F, 0.0F, false);
        bipedHead.setTextureOffset(0, 44).addBox(4.0F, -2.25F, -0.25F, 0.25F, 2.0F, 2.0F, 0.0F, false);
        bipedHead.setTextureOffset(0, 44).addBox(1.75F, -8.0F, -4.5F, 2.25F, 2.0F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(0, 44).addBox(2.75F, -6.0F, -4.5F, 1.25F, 2.25F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(0, 44).addBox(2.25F, -6.0F, -4.5F, 0.5F, 1.0F, 0.5F, 0.0F, false);
        ...
        bipedHead.setTextureOffset(1, 49).addBox(-4.0F, -6.0F, -4.5F, 3.0F, 3.0F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(1, 49).addBox(-1.0F, -6.0F, -4.5F, 1.0F, 2.5F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(1, 49).addBox(0.0F, -6.0F, -4.5F, 1.0F, 2.0F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(1, 49).addBox(1.0F, -6.0F, -4.5F, 1.25F, 1.25F, 0.5F, 0.0F, false);
        ...
        bipedHead.setTextureOffset(1, 44).addBox(-3.25F, 1.5F, 3.0F, 6.75F, 3.0F, 1.25F, 0.0F, false);
        bipedHead.setTextureOffset(1, 44).addBox(-2.5F, 4.5F, 3.0F, 5.0F, 3.0F, 1.25F, 0.0F, false);
