...
public class ModelEntityFletcherFemale extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public ModelEntityFletcherFemale()
    {
        ...
        bipedHead.setTextureOffset(11, 49).addBox(-4.25F, -8.0F, -0.25F, 0.25F, 5.5F, 4.25F, 0.0F, false);
        bipedHead.setTextureOffset(32, 47).addBox(4.0F, -8.0F, -1.5F, 0.25F, 5.75F, 5.5F, 0.0F, false);
        bipedHead.setTextureOffset(111, 48).addBox(-4.25F, -8.0F, -3.0F, 0.25F, 6.0F, 1.5F, 0.0F, false);
        bipedHead.setTextureOffset(116, 47).addBox(-4.25F, -8.0F, -1.5F, 0.25F, 6.75F, 1.25F, 0.0F, false);
        bipedHead.setTextureOffset(24, 51).addBox(4.0F, -8.0F, -3.0F, 0.25F, 5.25F, 1.5F, 0.0F, false);
        bipedHead.setTextureOffset(90, 49).addBox(-4.25F, -8.0F, -4.25F, 0.25F, 5.5F, 1.25F, 0.0F, false);
        bipedHead.setTextureOffset(28, 52).addBox(4.0F, -8.0F, -4.25F, 0.25F, 4.75F, 1.25F, 0.0F, false);
        bipedHead.setTextureOffset(18, 46).addBox(-4.25F, -2.5F, 1.75F, 0.25F, 3.75F, 2.25F, 0.0F, false);
        bipedHead.setTextureOffset(43, 47).addBox(4.0F, -2.25F, 1.75F, 0.25F, 3.75F, 2.25F, 0.0F, false);
        bipedHead.setTextureOffset(32, 47).addBox(-4.25F, -2.5F, -0.25F, 0.25F, 2.0F, 2.0F, 0.0F, false);
        bipedHead.setTextureOffset(45, 54).addBox(4.0F, -2.25F, -0.25F, 0.25F, 2.0F, 2.0F, 0.0F, false);
        bipedHead.setTextureOffset(0, 48).addBox(1.75F, -8.0F, -4.5F, 2.25F, 2.0F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(7, 55).addBox(2.75F, -6.0F, -4.5F, 1.25F, 2.25F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(11, 49).addBox(2.25F, -6.0F, -4.5F, 0.5F, 1.0F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(0, 46).addBox(-4.0F, -8.0F, -4.5F, 5.75F, 1.0F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(0, 51).addBox(-4.0F, -7.25F, -4.5F, 5.75F, 1.25F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(0, 55).addBox(-4.0F, -6.0F, -4.5F, 3.0F, 3.0F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(26, 48).addBox(-1.0F, -6.0F, -4.5F, 1.0F, 2.5F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(39, 48).addBox(0.0F, -6.0F, -4.5F, 1.0F, 2.0F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(6, 49).addBox(1.0F, -6.0F, -4.5F, 1.25F, 1.25F, 0.5F, 0.0F, false);
        bipedHead.setTextureOffset(86, 49).addBox(-4.0F, -8.25F, -4.0F, 8.0F, 0.25F, 8.0F, 0.0F, false);
