...
public class ModelEntityFletcherFemale extends CitizenModel<AbstractEntityCitizen>
{
    public ModelEntityFletcherFemale()
    {
        ...
        bipedLeftArm.setTextureOffset(69, 12).addBox(-1.25F, 7.0F, -2.25F, 3.5F, 1.0F, 4.5F, 0.0F, true);
        ...
        bipedRightArm.setTextureOffset(69, 18).addBox(-2.25F, 7.0F, -2.25F, 3.5F, 1.0F, 4.5F, 0.0F, true);
