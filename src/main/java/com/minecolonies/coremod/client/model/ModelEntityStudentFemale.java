    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition head =
          partdefinition.addOrReplaceChild("head",
            CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
              ...
              .texOffs(68, 2).addBox(-4.0F, -5.8F, -4.4F, 8.0F, 4.0F, 6.0F, new CubeDeformation(0.2F)),
            PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition HairExtension = head.addOrReplaceChild("HairExtension",
        ...
        PartDefinition body =
          partdefinition.addOrReplaceChild("body",
            CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
              .texOffs(16, 32).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.49F)),
            PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition breast = body.addOrReplaceChild("breast",
          CubeListBuilder.create().texOffs(64, 49).addBox(-3.0F, 1.8938F, -5.716F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
          PartPose.offsetAndRotation(-1.0F, 3.0F, 4.0F, -0.5236F, 0.0F, 0.0F));

        PartDefinition right_arm =
          partdefinition.addOrReplaceChild("right_arm",
            CubeListBuilder.create().texOffs(40, 16).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
              .texOffs(40, 32).addBox(-2.0F, -2.03F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.45F))
              .texOffs(64, 37).mirror().addBox(-1.7F, 7.5F, -3.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(-0.2F)).mirror(false),
            PartPose.offset(-5.0F, 2.0F, 0.0F));

        PartDefinition left_arm =
          partdefinition.addOrReplaceChild("left_arm",
            CubeListBuilder.create().texOffs(32, 48).addBox(-1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
              .texOffs(48, 48).addBox(-1.0F, -2.03F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.45F)),
            PartPose.offset(5.0F, 2.0F, 0.0F));
        ...
        PartDefinition rightShoulder =
          rightFoldedArm.addOrReplaceChild("rightShoulder",
            CubeListBuilder.create().texOffs(56, 16).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
              .texOffs(72, 16).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.25F)),
        ...
        PartDefinition rightForeArm =
          rightFoldedArm.addOrReplaceChild("rightForeArm",
            CubeListBuilder.create().texOffs(88, 16).addBox(-1.01F, -0.6F, -2.3F, 7.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
              .texOffs(88, 24).addBox(-1.01F, -0.6F, -2.3F, 7.0F, 3.0F, 4.0F, new CubeDeformation(0.251F)),
        ...
        PartDefinition leftShoulder = leftFoldedArm.addOrReplaceChild("leftShoulder",
          CubeListBuilder.create().texOffs(56, 26).mirror().addBox(-1.0F, -2.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
            .texOffs(72, 26).addBox(-1.0F, -2.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.25F)),
          PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.0472F, 0.0F, 0.0F));

        PartDefinition leftForeArm = leftFoldedArm.addOrReplaceChild("leftForeArm",
          CubeListBuilder.create().texOffs(88, 32).mirror().addBox(-4.0F, -0.6F, -2.3F, 7.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
            .texOffs(88, 40).mirror().addBox(-4.0F, -0.6F, -2.3F, 7.0F, 3.0F, 4.0F, new CubeDeformation(0.252F)).mirror(false),
          PartPose.offsetAndRotation(-1.0F, 2.5F, -3.8F, -1.0472F, 0.0F, 0.0F));
        ...
        PartDefinition right_leg =
          partdefinition.addOrReplaceChild("right_leg",
            CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
              .texOffs(0, 32).addBox(-2.1F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.6F)),
            PartPose.offset(-1.9F, 12.0F, 0.0F));

        PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg",
          CubeListBuilder.create().texOffs(16, 48).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
            .texOffs(0, 48).addBox(-1.95F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.591F)),
          PartPose.offset(1.9F, 12.0F, 0.0F));
