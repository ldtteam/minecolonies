...
public class ModelEntityFemaleSettler extends CitizenModel<AbstractEntityCitizen>
{
    public ModelEntityFemaleSettler(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
		...
		PartDefinition dress = body.addOrReplaceChild("dress", CubeListBuilder.create().texOffs(90, 14).addBox(-5.0F, -11.0F, -4.0F, 10.0F, 9.0F, 9.0F, new CubeDeformation(0.0F))
