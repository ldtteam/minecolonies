...
public class ModelEntityLumberjackFemale extends CitizenModel<AbstractEntityCitizen>{
	...
	bipedChestModelRenderer ponytailBase;
	bipedChestModelRenderer ponytailEnd;
	bipedChestModelRenderer chest;
	bipedChestModelRenderer logBottom;
	bipedChestModelRenderer logMiddle;
	bipedChestModelRenderer logTop;
	bipedChestModelRenderer BasketBL;
	bipedChestModelRenderer BasketTB;
	bipedChestModelRenderer BasketBR;
	bipedChestModelRenderer BasketTML;
	bipedChestModelRenderer BasketBF;
	bipedChestModelRenderer BasketMFR;
	bipedChestModelRenderer BasketMFL;
	bipedChestModelRenderer BasketMBL;
	bipedChestModelRenderer BasketMBR;
	bipedChestModelRenderer BasketTMR;
	bipedChestModelRenderer BasketBB;
