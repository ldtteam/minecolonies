...
public class ModelEntityDeliverymanFemale extends CitizenModel<AbstractEntityCitizen>
{
    public ModelEntityDeliverymanFemale()
    {
        ...
        final ModelPart RightB;
        final ModelPart Top;
        final ModelPart LeftB;
        final ModelPart RightM;
        final ModelPart FrontLB;
        final ModelPart LeftM;
        final ModelPart Back;
        final ModelPart BackM;
        final ModelPart FrontM;
        final ModelPart Front1;
        final ModelPart FrontLM;
        final ModelPart FrontRM;
        final ModelPart FrontRB;
        final ModelPart Front2;
        final ModelPart Base;
        final ModelPart RimL;
        final ModelPart Lid1;
        final ModelPart Lock1;
        final ModelPart Lock2;
        final ModelPart RimB;
        final ModelPart RimR;
        final ModelPart RimF;
        final ModelPart Lid2;
        final ModelPart Handle;
        final ModelPart Block1;
        final ModelPart Block2;
        final ModelPart Block3;
        final ModelPart Block4;
        final ModelPart Torch;
        ...
        RightB = new ModelPart(this, 7, 91);
        ...
        RightM = new ModelPart(this, 7, 86);
        ...
        FrontLB = new ModelPart(this, 0, 64);
        ...
        FrontM = new ModelPart(this, 0, 49);
        ...
        Front1 = new ModelPart(this, 0, 55);
        ...
        FrontLM = new ModelPart(this, 0, 60);
        ...
        FrontRM = new ModelPart(this, 7, 60);
        ...
        FrontRB = new ModelPart(this, 7, 65);
        ...
        Front2 = new ModelPart(this, 0, 58);
        ...
        Lock1 = new ModelPart(this, 50, 77);
        ...
        Lock2 = new ModelPart(this, 32, 77);
        ...
        Handle = new ModelPart(this, 32, 80);
        ...
        Block1 = new ModelPart(this, 32, 84);
        ...
        Block2 = new ModelPart(this, 40, 84);
        ...
        Block3 = new ModelPart(this, 32, 88);
        ...
        Block4 = new ModelPart(this, 40, 88);
        ...
        Torch = new ModelPart(this, 36, 80);
