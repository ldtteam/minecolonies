...
public class ModelEntityDeliverymanFemale extends CitizenModel
{
    public ModelEntityDeliverymanFemale()
    {
        ...
        bipedHead.addCuboid(-3.99F, -6F, -3.9F, 8, 8, 8);
        ...
        Chest.addCuboid(-4.01F, 4F, -1.4F, 8, 3, 3);
        ...
        bipedLeftArm.addCuboid(-1F, 0F, -4.9F, 4, 12, 4, 0F);
        ...
        bipedRightArm.addCuboid(-3F, 0F, -4.9F, 4, 12, 4, 0F);
        ...
        Top.addCuboid(-4.5F, -8.5F, -4.5F, 9, 1, 9);
        ...
        LeftB.addCuboid(3.8F, 3F, 3.5F, 1, 4, 1);
        ...
        RightM.addCuboid(-4.6F, 1.3F, 2.2F, 1, 3, 2);
        ...
        FrontLB.addCuboid(3.5F, -3.5F, -6F, 1, 2, 1);
        ...
        LeftM.addCuboid(3.5F, 1.2F, 2.2F, 1, 3, 2);
        ...
        Back.addCuboid(-4.5F, -7.5F, 2.5F, 9, 8, 2);
        ...
        BackM.addCuboid(-4.5F, -7.5F, 0.5F, 9, 4, 2);
        ...
        FrontM.addCuboid(-4.5F, -7.5F, -3.5F, 9, 2, 4);
        ...
        Front1.addCuboid(-4.48F, -6.5F, -7F, 9, 2, 1);
        ...
        FrontLM.addCuboid(3.49F, -5.5F, -6.5F, 1, 2, 2);
        ...
        FrontRM.addCuboid(-4.49F, -5.5F, -6.5F, 1, 3, 2);
        ...
        FrontRB.addCuboid(-4.5F, -2.5F, -6F, 1, 3, 1);
        ...
        Front2.addCuboid(-4.51F, -7.5F, -4.5F, 9, 1, 1);
        ...
        Base.addCuboid(-4F, 4F, 0.1F, 8, 6, 6);
        ...
        RimL.addCuboid(3F, 3F, 1.1F, 1, 1, 4);
        ...
        Lock1.addCuboid(-0.5F, -4.01F, 2.5F, 1, 0, 2);
        ...
        Lock2.addCuboid(-0.5F, -6.1F, 2.5F, 1, 0, 2);
        ...
        RimB.addCuboid(-4F, 3F, 5.1F, 8, 1, 1);
        ...
        RimR.addCuboid(-4F, 3F, 1.1F, 1, 1, 4);
        ...
        RimF.addCuboid(-4F, 3F, 0.1F, 8, 1, 1);
        ...
        Lid2.addCuboid(-4F, 0.12F, -2.99F, 8, 6, 1);
        ...
        Handle.addCuboid(-1F, 5F, -0.1F, 1, 2, 1);
        ...
        Block1.addCuboid(-2F, 3.5F, -0.9F, 2, 2, 2);
        ...
        Block2.addCuboid(-2F, 4F, -0.9F, 2, 2, 2);
        ...
        Block3.addCuboid(-3F, 4F, -2.9F, 2, 2, 2);
        ...
        Block4.addCuboid(-3F, 4F, -2.9F, 2, 2, 2);
        ...
        Torch.addCuboid(-1F, 3F, -2.9F, 1, 2, 1);
