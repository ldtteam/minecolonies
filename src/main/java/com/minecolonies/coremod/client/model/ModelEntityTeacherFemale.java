...
public class ModelEntityTeacherFemale extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public ModelEntityTeacherFemale(final ModelPart part)
    {
        super(part);
        hat.visible = false;

        IMinecoloniesAPI.getInstance().getModelTypeRegistry().register(BipedModelType.TEACHER, true, this);
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition ponytail_1Definition = hairDefinition.addOrReplaceChild("ponytail_1",
          CubeListBuilder.create()
            .texOffs(66, 57).addBox(-7.5F, -4.7814F, -0.1798F, 1.0F, 1.0F, 4.0F).mirror()
        ...
        PartDefinition ponytail_2Definition = hairDefinition.addOrReplaceChild("ponytail_2",
          CubeListBuilder.create()
            .texOffs(26, 53).addBox(-7.5F, -5.3091F, -0.3407F, 3.0F, 2.0F, 4.0F).mirror()
        ...
        PartDefinition ponytail_3Definition = hairDefinition.addOrReplaceChild("ponytail_3",
          CubeListBuilder.create()
            .texOffs(47, 56).addBox(-7.5F, -5.737F, -0.1521F, 2.0F, 2.0F, 4.0F).mirror()
        ...
        PartDefinition bipedChestDefinition = bodyDefinition.addOrReplaceChild("bipedChest",
          CubeListBuilder.create()
            .texOffs(40, 32).addBox(-3.0F, 2.7F, -0.5F, 6.0F, 3.0F, 4.0F)
