...
public class ModelEntityTeacherFemale extends CitizenModel<AbstractEntityCitizen>
{
    public ModelEntityTeacherFemale()
    {
        ...
        ponytail_1.texOffs(66, 57).addBox(-7.5F, -4.7814F, -0.1798F, 1.0F, 1.0F, 4.0F, 0.0F, true);
        ...
        ponytail_2.texOffs(26, 53).addBox(-7.5F, -5.3091F, -0.3407F, 3.0F, 2.0F, 4.0F, 0.0F, true);
        ...
        ponytail_3.texOffs(47, 56).addBox(-7.5F, -5.737F, -0.1521F, 2.0F, 2.0F, 4.0F, 0.0F, true);
        ...
        bipedChest.texOffs(40, 32).addBox(-3.0F, 2.7F, -0.5F, 6.0F, 3.0F, 4.0F, 0.0F, false);
