...
public class ModelEntityCowFarmerFemale extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public ModelEntityCowFarmerFemale(final ModelPart part)
    {
        super(part);
        hat.visible = false;

        IMinecoloniesAPI.getInstance().getModelTypeRegistry().register(BipedModelType.COW_FARMER, true, this);
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition bagRDefinition = backpackDefinition.addOrReplaceChild("bagR",
          CubeListBuilder.create()
            .texOffs(94, 4).addBox(3.0F, 0.0F, 3.0F, 1.0F, 9.0F, 3.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bagLDefinition = backpackDefinition.addOrReplaceChild("bagL",
          CubeListBuilder.create()
            .texOffs(94, 16).addBox(-4.0F, 0.0F, 3.0F, 1.0F, 9.0F, 3.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bagBackDefinition = backpackDefinition.addOrReplaceChild("bagBack",
          CubeListBuilder.create()
            .texOffs(102, 13).addBox(-3.0F, 0.0F, 2.0F, 6.0F, 9.0F, 1.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bagFrontDefinition = backpackDefinition.addOrReplaceChild("bagFront",
          CubeListBuilder.create()
            .texOffs(102, 4).addBox(-3.0F, 1.0F, 6.0F, 6.0F, 8.0F, 1.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bagWheatDefinition = backpackDefinition.addOrReplaceChild("bagWheat",
          CubeListBuilder.create()
            .texOffs(94, 0).addBox(-3.0F, 1.5F, 3.0F, 6.0F, 1.0F, 3.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bagBotDefinition = backpackDefinition.addOrReplaceChild("bagBot",
          CubeListBuilder.create()
            .texOffs(102, 23).addBox(-3.0F, 9.0F, 3.0F, 6.0F, 1.0F, 3.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bipedChestDefinition = bodyDefinition.addOrReplaceChild("bipedChest",
          CubeListBuilder.create()
            .texOffs(40, 32).addBox(-3.5F, 2.7F, -0.5F, 7.0F, 3.0F, 4.0F)
