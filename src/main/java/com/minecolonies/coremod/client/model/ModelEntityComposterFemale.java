...
public class ModelEntityComposterFemale extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public ModelEntityComposterFemale(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition bootLDefinition = leftLegDefinition.addOrReplaceChild("bootL",
          CubeListBuilder.create()
            .texOffs(96, 6).addBox(-4.5F, -8.0F, -2.5F, 5.0F, 2.0F, 5.0F).mirror()
          , PartPose.offset(2.0F, 12.0F, 0.0F));
        ...
        PartDefinition bootRDefinition = rightLegDefinition.addOrReplaceChild("bootR",
          CubeListBuilder.create()
            .texOffs(76, 6).addBox(-0.5F, -8.0F, -2.5F, 5.0F, 2.0F, 5.0F).mirror()
          , PartPose.offset(-2.0F, 12.0F, 0.0F));
        ...
        PartDefinition gloveLDefinition = leftArmDefinition.addOrReplaceChild("gloveL",
          CubeListBuilder.create()
            .texOffs(96, 0).addBox(-6.5F, 3.0F, -2.5F, 4.0F, 1.0F, 5.0F).mirror()
          , PartPose.offset(5.0F, 2.0F, 0.0F));
        ...
        PartDefinition gloveRDefinition = rightArmDefinition.addOrReplaceChild("gloveR",
          CubeListBuilder.create()
            .texOffs(76, 0).addBox(2.5F, 3.0F, -2.5F, 4.0F, 1.0F, 5.0F).mirror()
          , PartPose.offset(-5.0F, 2.0F, 0.0F));
