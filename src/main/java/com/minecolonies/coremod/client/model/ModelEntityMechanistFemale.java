...
public class ModelEntityMechanistFemale extends CitizenModel<AbstractEntityCitizen> {
	...
	public ModelEntityMechanistFemale() {
		...
		torch3.setRotationPoint(0.0F, 0.0F, 0.0F);
		...
		chest.setTextureOffset(53, 29).addBox(-3.0F, 5.5566F, 4.181F, 6.0F, 3.0F, 3.0F, 0.0F, false);
		...
		hair.setTextureOffset(22, 36).addBox(-4.5F, -32.0F, -4.25F, 1.0F, 4.25F, 8.5F, 0.0F, false);
		hair.setTextureOffset(41, 35).addBox(3.5F, -32.0F, -4.25F, 1.0F, 4.25F, 8.5F, 0.0F, false);
		hair.setTextureOffset(16, 47).addBox(-4.5F, -28.0F, 1.75F, 1.0F, 3.0F, 2.5F, 0.0F, false);
		hair.setTextureOffset(24, 49).addBox(3.5F, -28.0F, 1.75F, 1.0F, 3.0F, 2.5F, 0.0F, false);
		hair.setTextureOffset(33, 36).addBox(-4.5F, -28.0F, -2.0F, 1.0F, 2.25F, 3.75F, 0.0F, false);
		hair.setTextureOffset(53, 36).addBox(3.5F, -28.0F, -2.75F, 1.0F, 2.25F, 4.5F, 0.0F, false);
		hair.setTextureOffset(65, 36).addBox(-4.25F, -32.0F, 3.75F, 8.5F, 8.0F, 0.75F, 0.0F, false);
		hair.setTextureOffset(33, 48).addBox(-4.25F, -32.25F, -4.25F, 8.5F, 0.5F, 8.5F, 0.0F, false);
		hair.setTextureOffset(34, 53).addBox(-4.25F, -32.0F, -4.75F, 2.5F, 1.75F, 0.5F, 0.0F, false);
		hair.setTextureOffset(61, 46).addBox(1.75F, -32.0F, -4.75F, 2.5F, 1.75F, 0.5F, 0.0F, false);
		hair.setTextureOffset(60, 49).addBox(-1.75F, -32.0F, -4.75F, 3.5F, 1.0F, 0.5F, 0.0F, false);
		hair.setTextureOffset(60, 52).addBox(-1.75F, -31.5F, -4.75F, 1.0F, 1.0F, 0.5F, 0.0F, false);
		hair.setTextureOffset(64, 52).addBox(-4.25F, -30.75F, -4.75F, 2.5F, 1.25F, 0.5F, 0.0F, false);
		hair.setTextureOffset(35, 50).addBox(2.5F, -30.75F, -4.75F, 1.75F, 1.25F, 0.5F, 0.0F, false);
