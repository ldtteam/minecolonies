...
public class ModelEntityChickenFarmerFemale extends CitizenModel<AbstractEntityCitizen>
{
    public ModelEntityChickenFarmerFemale()
    {
        ...
        feed.setTextureOffset(74, 41).addBox(3.3F, 9.8F, -2.5F, 1.0F, 2.0F, 5.0F, 0.0F, true);

        strap = new ModelRenderer(this);
        strap.setRotationPoint(-1.0F, 1.5F, -1.0F);
        bipedBody.addChild(strap);
        setRotationAngle(strap, 0.0F, 0.0F, -0.3316F);
        strap.setTextureOffset(89, 26).addBox(-4.0F, -3.0F, -2.0F, 1.0F, 6.0F, 6.0F, 0.0F, true);

        strap_2 = new ModelRenderer(this);
        strap_2.setRotationPoint(1.0F, 4.5F, -1.0F);
        bipedBody.addChild(strap_2);
        setRotationAngle(strap_2, 0.0F, 0.0F, -0.8901F);
        strap_2.setTextureOffset(89, 50).addBox(-4.0F, -3.0F, -2.0F, 1.0F, 8.0F, 6.0F, 0.0F, true);
