...
public class ModelEntityChickenFarmerFemale extends CitizenModel<AbstractEntityCitizen>
{
    public ModelEntityChickenFarmerFemale()
    {
        ...
        body.addChild(feed);
        feed.texOffs(74, 41).addBox(3.3F, 9.8F, -2.5F, 1.0F, 2.0F, 5.0F, 0.0F, true);

        strap = new ModelRenderer(this);
        strap.setPos(-1.0F, 1.5F, -1.0F);
        body.addChild(strap);
        setRotationAngle(strap, 0.0F, 0.0F, -0.3316F);
        strap.texOffs(89, 26).addBox(-4.0F, -3.0F, -2.0F, 1.0F, 6.0F, 6.0F, 0.0F, true);

        strap_2 = new ModelRenderer(this);
        strap_2.setPos(1.0F, 4.5F, -1.0F);
        body.addChild(strap_2);
        setRotationAngle(strap_2, 0.0F, 0.0F, -0.8901F);
        strap_2.texOffs(89, 50).addBox(-4.0F, -3.0F, -2.0F, 1.0F, 8.0F, 6.0F, 0.0F, true);

        baseBag = new ModelRenderer(this);
        baseBag.setPos(0.0F, 0.0F, 0.0F);
        body.addChild(baseBag);
        baseBag.texOffs(88, 40).addBox(2.4667F, 10.0F, -3.0F, 2.0F, 2.0F, 6.0F, 0.0F, true);
