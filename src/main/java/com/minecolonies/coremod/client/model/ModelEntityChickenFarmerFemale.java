...
public class ModelEntityChickenFarmerFemale extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public ModelEntityChickenFarmerFemale(final ModelPart part)
    {
        super(part);
        hat.visible = false;

        IMinecoloniesAPI.getInstance().getModelTypeRegistry().register(BipedModelType.CHICKEN_FARMER, true, this);
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition feedDefinition = bodyDefinition.addOrReplaceChild("feed",
          CubeListBuilder.create()
            .texOffs(74, 41).addBox(3.3F, 9.8F, -2.5F, 1.0F, 2.0F, 5.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition strapDefinition = bodyDefinition.addOrReplaceChild("strap",
          CubeListBuilder.create()
            .texOffs(89, 26).addBox(-4.0F, -3.0F, -2.0F, 1.0F, 6.0F, 6.0F).mirror()
            .texOffs(89, 50).addBox(-4.0F, -3.0F, -2.0F, 1.0F, 8.0F, 6.0F).mirror()
          , PartPose.offsetAndRotation(1.0F, 4.5F, -1.0F, 0.0F, 0.0F, -0.8901F));

        PartDefinition strap_2Definition = bodyDefinition.addOrReplaceChild("strap_2",
          CubeListBuilder.create()
            .texOffs(89, 50).addBox(-4.0F, -3.0F, -2.0F, 1.0F, 8.0F, 6.0F).mirror()
          , PartPose.offsetAndRotation(1.0F, 4.5F, -1.0F, 0.0F, 0.0F, -0.8901F));
        ...
        PartDefinition baseBagDefinition = bodyDefinition.addOrReplaceChild("baseBag",
          CubeListBuilder.create()
            .texOffs(88, 40).addBox(2.4667F, 10.0F, -3.0F, 2.0F, 2.0F, 6.0F).mirror()
          , PartPose.offset(0.0F, 0.0F, 0.0F));
