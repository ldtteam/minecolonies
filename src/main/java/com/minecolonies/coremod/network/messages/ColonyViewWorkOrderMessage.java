...
public class ColonyViewWorkOrderMessage implements IMessage
{
    ...
    {
        IColonyManager.getInstance().handleColonyViewWorkOrderMessage(message.colonyId, message.workOrderBuffer, Minecraft.getInstance().world.provider.getDimension());
    }
}
