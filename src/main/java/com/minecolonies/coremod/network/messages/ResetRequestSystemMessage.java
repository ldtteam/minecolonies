 ...
 */
public class ResetRequestSystemMessage implements IMessage
{
    /**
     * The Colony ID.
     */
     ...
     */
    public ResetRequestSystemMessage()
    {
        super();
    }
     ...
     */
    public ResetRequestSystemMessage(@NotNull final IColonyView colony)
    {
        super();
