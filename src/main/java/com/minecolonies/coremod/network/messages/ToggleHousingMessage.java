...
public class ToggleHousingMessage extends AbstractMessage<ToggleHousingMessage, IMessage>
{
     ...
     */
    public ToggleHousingMessage(@NotNull final ColonyView colony, final boolean toggle)
    {
        super();
     ...
     */
    @Override
    public void messageOnServerThread(final ToggleHousingMessage message, final PlayerEntityMP player)
    {
