...
public class OpenInventoryMessage extends AbstractColonyServerMessage
{
    ...
    {
        @NotNull final TileEntityScarecrow tileEntityScarecrow = (TileEntityScarecrow) BlockPosUtil.getTileEntity(CompatibilityUtils.getWorldFromEntity(player), tePos);
        NetworkHooks.openGui(player, tileEntityScarecrow);
    }
