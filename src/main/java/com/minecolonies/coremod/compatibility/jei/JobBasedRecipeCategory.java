...
@SuppressWarnings({"ClassWithoutLogger", "LocalVariableOfConcreteClass", "MethodReturnOfConcreteClass", "FeatureEnvy", "InstanceVariableOfConcreteClass"})
public abstract class JobBasedRecipeCategory<T> implements IRecipeCategory<T>
{
    ...
    @SuppressWarnings({"LocalVariableOfConcreteClass", "ConditionalExpression", "AssignmentOrReturnOfFieldWithMutableType"})
    protected static class LootTableTooltipCallback implements ITooltipCallback<ItemStack>
    {
        ...
        @Override
        public void onTooltip(final int slot, final boolean input, final ItemStack stack, final List<ITextComponent> tooltip)
        {
