...
public class ColonyBorderMapping
{
    ...
    private static class ColonyBorderOverlay
    {
        ...
        private static final Codec<RegistryKey<World>> CODEC_DIMENSION =
                ResourceLocation.CODEC.xmap(c -> RegistryKey.create(Registry.DIMENSION_REGISTRY, c), RegistryKey::location);
        ...
        static final Codec<ColonyBorderOverlay> CODEC =
                RecordCodecBuilder.create(instance -> instance.group(
                        CODEC_DIMENSION.fieldOf("dimension").forGetter(o -> o.dimension),
        ...
        /** Deserialization */
        private ColonyBorderOverlay(@NotNull final RegistryKey<World> dimension,
                                    final int id,
