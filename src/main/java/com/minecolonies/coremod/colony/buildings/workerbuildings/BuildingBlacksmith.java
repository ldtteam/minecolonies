...
public class BuildingBlacksmith extends AbstractBuildingCrafter
{
    ...
    {
        final UnlockBuildingResearchEffect effect = colony.getResearchManager().getResearchEffects().getEffect(BLACKSMITH_RESEARCH, UnlockBuildingResearchEffect.class);
        if (effect == null)
        {
