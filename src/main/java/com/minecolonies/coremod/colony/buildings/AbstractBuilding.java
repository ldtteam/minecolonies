...
public abstract class AbstractBuilding extends AbstractBuildingContainer
{
    ...
    public void serializeToView(@NotNull final PacketBuffer buf)
    {
        ...
        buf.writeUtf(this.getCustomBuildingName());
    ...
    public void requestUpgrade(final PlayerEntity player, final BlockPos builder)
    {
        ...
        {
            player.sendMessage(new TranslationTextComponent("com.minecolonies.coremod.research.havetounlock"), player.createPlayerUUID());
            return;
        }
        ...
        {
            player.sendMessage(new TranslationTextComponent("com.minecolonies.coremod.research.unlocktoupgrade"), player.createPlayerUUID());
            return;
        }
        ...
        {
            player.sendMessage(new TranslationTextComponent("com.minecolonies.coremod.worker.noupgrade"), player.createPlayerUUID());
        }
    }
    ...
    public Map<Predicate<ItemStack>, Tuple<Integer, Boolean>> getRequiredItemsAndAmount()
    {
        ...
        toKeep.putAll(requiredItems.entrySet().stream().collect(Collectors.toMap(key -> (stack -> stack.sameItem(key.getKey().getItemStack())), Map.Entry::getValue)));
