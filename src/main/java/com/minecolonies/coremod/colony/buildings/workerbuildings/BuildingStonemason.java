...
public class BuildingStonemason extends AbstractBuildingCrafter
{
    ...
    {
        final UnlockBuildingResearchEffect effect = colony.getResearchManager().getResearchEffects().getEffect(STONEMASON_RESEARCH, UnlockBuildingResearchEffect.class);
        if (effect == null)
        {
