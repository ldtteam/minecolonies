...
import com.minecolonies.coremod.colony.requestsystem.management.manager.wrapped.simulation.SimulationRequestManager;
...
public class StandardRequestManager implements IStandardRequestManager
{
    ...
    {
        final IRequest<T> internalRequest = (IRequest<T>) RequestHandler.getRequestOrNull(this, token);
    ...
    {
        return SimulationRequestManager.create(this);
    }
    ...
    {
        deserializeNBT(simulatingRequestManager.serializeNBT());
    }
