...
public class StandardRetryingRequestResolver implements IRetryingRequestResolver
{
    ...
    @Override
    public TypeToken<IRetryable> getRequestType()
    {
        return TypeConstants.RETRYABLE;
    }

    @Override
    public <T extends IRetryable> boolean canResolve(
    ...
    @Nullable
    @Override
    public <T extends IRetryable> List<IToken<?>> attemptResolve(
    ...
    @Nullable
    @Override
    public <T extends IRetryable> void resolve(
    ...
    @Nullable
    @Override
    public <T extends IRetryable> IRequest<?> getFollowupRequestForCompletion(
    ...
    @Nullable
    @Override
    public <T extends IRetryable> IRequest<?> onRequestCancelledOrOverruled(
