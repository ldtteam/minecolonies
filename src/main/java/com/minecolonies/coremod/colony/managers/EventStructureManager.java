...
public class EventStructureManager implements IEventStructureManager
{
      ...
      final Mirror mirror)
    {
        ...
        final BlockPos spawnPos = targetSpawnPoint.relative(0, -y, 0);

        final BlockPos zeroPos = targetSpawnPoint.subtract(structure.getPrimaryBlockOffset()).relative(0, -y, 0);
