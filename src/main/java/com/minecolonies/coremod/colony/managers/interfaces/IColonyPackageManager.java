...
public interface IColonyPackageManager
{
     ...
     */
    Set<PlayerEntityMP> getSubscribers();
     ...
     */
    void sendColonyViewPackets(@NotNull final Set<PlayerEntityMP> oldSubscribers, final boolean hasNewSubscribers);
     ...
     */
    void sendPermissionsPackets(@NotNull final Set<PlayerEntityMP> oldSubscribers, final boolean hasNewSubscribers);
     ...
     * @param hasNewSubscribers the new subscribers.
     */
    void sendWorkOrderPackets(@NotNull final Set<PlayerEntityMP> oldSubscribers, final boolean hasNewSubscribers);
     ...
     */
    void addSubscribers(@NotNull final PlayerEntityMP subscriber);

    /**
     * Remove an old subsriber from the colony.
     * @param player the subscriber to remove.
     */
    void removeSubscriber(@NotNull final PlayerEntityMP player);
}
