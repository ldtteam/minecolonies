...
public class CommandChangeOwner implements IMCColonyOfficerCommand
{
    ...
    public int onExecute(final CommandContext<CommandSource> context)
    {
        ...
        context.getSource().sendSuccess(new TranslationTextComponent(CommandTranslationConstants.COMMAND_OWNER_CHANGE_SUCCESS, profile.getName(), colony.getName()), true);
        return 1;
    }
