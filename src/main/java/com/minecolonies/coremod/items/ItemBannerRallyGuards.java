...
public class ItemBannerRallyGuards extends AbstractItemMinecolonies
{
    ...
    {
        super("banner_rally_guards", properties.stacksTo(1).durability(0).tab(ModCreativeTabs.MINECOLONIES));
    }
    ...
    public ActionResultType useOn(final ItemUseContext context)
    {
        ...
        final ItemStack banner = context.getPlayer().getLastHandItem(context.getHand());
    ...
    {
        final ItemStack banner = playerIn.getLastHandItem(handIn);
    ...
    public static int broadcastPlayerToRally(final ItemStack banner, final World worldIn, @Nullable final PlayerEntity playerIn)
    {
        ...
        {
            rallyTarget = new EntityLocation(playerIn.createPlayerUUID());
        }
