                                           ...
                                           @NotNull final ExistingFileHelper fileHelper)
    {
        ...
        final Advancement root = Advancement.Builder.advancement()
                .display(ModBlocks.blockHutBuilder,
                        new TranslationTextComponent("advancements.minecolonies.root.production.title"),
                        new TranslationTextComponent("advancements.minecolonies.root.production.description"),
        ...
        final Advancement postAndStash = Advancement.Builder.advancement()
                ...
                .addCriterion("postbox", PlacedBlockTrigger.Instance.placedBlock(ModBlocks.blockPostBox))
                .addCriterion("stash", PlacedBlockTrigger.Instance.placedBlock(ModBlocks.blockStash))
                                         ...
                                         @NotNull final ExistingFileHelper fileHelper)
    {
        ...
        final Advancement root = Advancement.Builder.advancement()
                .display(ModBlocks.blockHutBarracks,
                        new TranslationTextComponent("advancements.minecolonies.root.military.title"),
                        new TranslationTextComponent("advancements.minecolonies.root.military.description"),
