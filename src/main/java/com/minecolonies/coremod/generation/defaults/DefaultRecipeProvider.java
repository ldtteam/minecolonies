...
//                .save(consumer);
                           ...
                           final int cookingTime)
    {
        ...
        CookingRecipeBuilder.cooking(Ingredient.of(ModItems.cakeBatter),
        ...
        CookingRecipeBuilder.cooking(Ingredient.of(ModItems.cookieDough),
        ...
        CookingRecipeBuilder.cooking(Ingredient.of(ModItems.rawPumpkinPie),
