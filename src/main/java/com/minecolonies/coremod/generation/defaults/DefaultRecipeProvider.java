...
import static com.ldtteam.structurize.blocks.ModBlocks.blockDecoBarrel_standing;
...
public class DefaultRecipeProvider extends RecipeProvider
{
    ...
    protected void buildShapelessRecipes(@NotNull final Consumer<IFinishedRecipe> consumer)
    {
        ...
        buildFood(consumer, "", IRecipeSerializer.SMELTING_RECIPE, 200);
        buildFood(consumer, "smoking", IRecipeSerializer.SMOKING_RECIPE, 100);
        buildFood(consumer, "campfire_cooking", IRecipeSerializer.CAMPFIRE_COOKING_RECIPE, 600);
    ...
    private void buildHutRecipes(@NotNull final Consumer<IFinishedRecipe> consumer)
    {
        ...
        registerHutRecipe1(consumer, ModBlocks.blockHutTavern, blockDecoBarrel_standing.get());
...
//                .save(consumer);
    ...
    private static ResourceLocation append(@NotNull final IItemProvider item,
                                           @NotNull final String text)
    {
        return append(item.asItem().getRegistryName(), "", text);
    }

    private static void registerHutRecipe1(@NotNull final Consumer<IFinishedRecipe> consumer,
                                           @NotNull final IItemProvider output,
                                           @NotNull final IItemProvider input)
    {
    ...
    private static void registerHutRecipe1x2(@NotNull final Consumer<IFinishedRecipe> consumer,
                                             @NotNull final IItemProvider output,
                                             @NotNull final IItemProvider input,
    ...
    private static void registerHutRecipe3(@NotNull final Consumer<IFinishedRecipe> consumer,
                                           @NotNull final IItemProvider output,
                                           @NotNull final IItemProvider input)
    {
        ShapedRecipeBuilder.shaped(output)
    ...
    private void buildOtherBlocks(@NotNull final Consumer<IFinishedRecipe> consumer)
    {
    ...
    private void buildFood(@NotNull final Consumer<IFinishedRecipe> consumer,
                           @NotNull final String method,
                           @NotNull final CookingRecipeSerializer<?> serializer,
                           final int cookingTime)
    {
        CookingRecipeBuilder.cooking(Ingredient.of(ModItems.breadDough),
        ...
        CookingRecipeBuilder.smelting(Ingredient.of(ModItems.cakeBatter),
        ...
        CookingRecipeBuilder.smelting(Ingredient.of(ModItems.cookieDough),
        ...
        CookingRecipeBuilder.smelting(Ingredient.of(ModItems.rawPumpkinPie),
    ...
    private void buildOtherItems(@NotNull final Consumer<IFinishedRecipe> consumer)
    {
        ...
        CookingRecipeBuilder.smelting(Ingredient.of(ModItems.scimitar), Items.IRON_NUGGET, 0.1f, 200)
        ...
        CookingRecipeBuilder.blasting(Ingredient.of(ModItems.scimitar), Items.IRON_NUGGET, 0.1f, 100)
                .unlockedBy("has_scimitar", has(ModItems.scimitar))
