...
public class ContainerMinecoloniesBuildingInventory extends Container
{
     ...
     * @param buildingLocation      the building id.
    ...
    public ContainerMinecoloniesBuildingInventory(
      ...
      final int colonyId,
      final BlockPos buildingLocation, final World world)
    {
        this.colony = ColonyManager.getColonyByPosFromWorld(world, buildingLocation);
