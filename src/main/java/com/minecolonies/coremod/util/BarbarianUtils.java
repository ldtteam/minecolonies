...
public final class BarbarianUtils
{
     ...
     */
    private static final String  barbarian = Constants.MOD_ID + ":entity/ai/mobs/EntityBarbarian";
    private static final String archer    = Constants.MOD_ID + ":entity/ai/mobs/EntityArcherBarbarian";
    private static final String chief     = Constants.MOD_ID + ":entity/ai/mobs/EntityChiefBarbarian";
     ...
     */
    private static void spawn(final String entityToSpawn, final int numberOfSpawns, final BlockPos spawnLocation, final World world)
    {
     ...
     */
    private static void setBarbarianItems(final String entityToSpawn, final Entity entity)
    {
