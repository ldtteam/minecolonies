...
public final class RecipeHandler
{
    ...
    public static void init(final boolean enableInDevelopmentFeatures, final boolean supplyChests)
    {
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(
                new ItemStack(ModBlocks.blockShingleOak, EIGHT_BLOCKS, 0), "B  ", "SB ", "BSP", 'B', Items.BRICK, 'P',
                new ItemStack(Blocks.PLANKS, 1, 0), 'S', WOODEN_STICK));
        GameRegistry.addRecipe(new ShapedOreRecipe(
                new ItemStack(ModBlocks.blockShingleSpruce, EIGHT_BLOCKS, 0), "B  ", "SB ", "BSP", 'B', Items.BRICK, 'P',
                new ItemStack(Blocks.PLANKS, 1, 1), 'S', WOODEN_STICK));
        GameRegistry.addRecipe(new ShapedOreRecipe(
                new ItemStack(ModBlocks.blockShingleBirch, EIGHT_BLOCKS, 0), "B  ", "SB ", "BSP", 'B', Items.BRICK, 'P',
                new ItemStack(Blocks.PLANKS, 1, 2), 'S', WOODEN_STICK));
        GameRegistry.addRecipe(new ShapedOreRecipe(
                new ItemStack(ModBlocks.blockShingleJungle, EIGHT_BLOCKS, 0), "B  ", "SB ", "BSP", 'B', Items.BRICK, 'P',
                new ItemStack(Blocks.PLANKS, 1, 3), 'S', WOODEN_STICK));
        GameRegistry.addRecipe(new ShapedOreRecipe(
                new ItemStack(ModBlocks.blockShingleAcacia, EIGHT_BLOCKS, 0), "B  ", "SB ", "BSP", 'B', Items.BRICK, 'P',
                new ItemStack(Blocks.PLANKS, 1, 4), 'S', WOODEN_STICK));
        GameRegistry.addRecipe(new ShapedOreRecipe(
                new ItemStack(ModBlocks.blockShingleDarkOak, EIGHT_BLOCKS, 0), "B  ", "SB ", "BSP", 'B', Items.BRICK, 'P',
