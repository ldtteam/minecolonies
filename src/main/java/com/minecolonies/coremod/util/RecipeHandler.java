...
public final class RecipeHandler
{
    ...
    public static void init(final boolean enableInDevelopmentFeatures, final boolean supplyChests)
    {
        ...
        //Building blocks
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.blockTimberFrame, FOUR_BLOCKS), " W ", " W ", " WB", 'W', PLANK_WOOD, 'B', ModItems.buildTool));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.blockPaperWall, EIGHT_BLOCKS, 0), "WWW", "PPP", "WWW", 'P', PAPER, 'W', new ItemStack(Blocks.PLANKS, 1, 0)));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.blockPaperWall, EIGHT_BLOCKS, 3), "WWB", "WBB", "PPP", 'P', PAPER, 'P', new ItemStack(Blocks.PLANKS, 1), 'B', new ItemStack(Items.BRICK, 1)));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.blockPaperWall, EIGHT_BLOCKS, 3), "BWW", "BBW", "PPP", 'P', PAPER, 'P', new ItemStack(Blocks.PLANKS, 1), 'B', new ItemStack(Items.BRICK, 1)));
