...
public abstract class AttributeModifierUtils
{
    ...
    public static void removeAllHealthModifiers(final EntityLivingBase entity)
    {
        ...
        for (final AttributeModifier mod : entity.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).getModifiers())
        {
            entity.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).removeModifier(mod);
        }
    ...
    public static void addHealthModifier(final EntityLivingBase entity, final AttributeModifier modifier)
    {
        ...
        entity.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).applyModifier(modifier);
