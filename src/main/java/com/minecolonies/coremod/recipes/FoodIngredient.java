...
public class FoodIngredient extends Ingredient
{
    ...
    public static final Predicate<ItemStack> ISFOOD
            = stack -> ItemStackUtils.isNotEmpty(stack) && stack.isEdible() && stack.getItem().getFoodProperties().getNutrition() > 0 && stack.getItem().getFoodProperties().getSaturationModifier() > 0;
