 ...
 */
public class RaiderRangedAI<T extends AbstractEntityMinecoloniesMob & IRangedMobEntity> extends AttackMoveAI<T>
{
    /**
    ...
    @SuppressWarnings("unchecked") // generic hell, owner argument should be T type
    public RaiderRangedAI(
      final AbstractEntityMinecoloniesMob owner,
      final ITickRateStateMachine<IAIState> stateMachine)
    {
        super((T) owner, stateMachine);
    }
