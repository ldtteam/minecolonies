...
public class RaiderMeleeAI<T extends AbstractEntityMinecoloniesMob & IThreatTableEntity> extends AttackMoveAI<T>
{
    ...
    protected void doAttack(final LivingEntity target)
    {
        ...
        target.hurt(target.level.damageSources().source(ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(Constants.MOD_ID, ((TranslatableContents) user.getName().getContents()).getKey())), user), (float) damageToBeDealt);
