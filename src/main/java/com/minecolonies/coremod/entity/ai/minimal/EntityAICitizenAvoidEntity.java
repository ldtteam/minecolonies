...
public class EntityAICitizenAvoidEntity extends Goal
{
    ...
    private boolean performMoveAway()
    {
        ...
        {
            moveAwayPath =
              citizen.getNavigation().moveAwayFromXYZ(citizen.blockPosition().relative(rand.nextInt(2), 0, rand.nextInt(2)), distanceFromEntity + getMoveAwayDist(citizen), nearSpeed);
