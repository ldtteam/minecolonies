...
public class MobAIRegistry implements IMobAIRegistry
{
    ...
    private static void setupMobAiTasks(final IMobAIRegistry registry)
    {
        registry
          ...
          .registerNewAiTargetTaskForMobs(PRIORITY_THREE, EntityAIBreakDoor::new)
          ...
          .registerNewStateAI(mob -> new RaiderRangedAI<>(mob, mob.getAI()), mob -> mob instanceof IArcherMobEntity || mob instanceof ISpearmanMobEntity)
