...
public abstract class AbstractEntityAICrafting<J extends AbstractJobCrafter<?, J>, B extends AbstractBuildingWorker> extends AbstractEntityAIInteract<J, B>
{
    ...
    protected IAIState getRecipe()
    {
        ...
        for (final ItemStorage inputStorage : input)
        {
            ...
            final int remaining;
            if(!currentRecipeStorage.getSecondaryOutputs(true).isEmpty() && ItemStackUtils.compareItemStackListIgnoreStackSize(currentRecipeStorage.getSecondaryOutputs(true), inputStorage.getItemStack(), false, true))
            {
