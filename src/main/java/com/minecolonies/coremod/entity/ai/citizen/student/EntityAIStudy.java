...
public class EntityAIStudy extends AbstractEntityAISkill<JobStudent, BuildingLibrary>
{
    ...
    private IAIState study()
    {
        ...
        else
        {
            ...
            worker.setLastHandItem(Hand.MAIN_HAND, new ItemStack(chosenItem.getItem(), 1));
            data.getCitizenSkillHandler().tryLevelUpIntelligence(world.random, ONE_IN_X_CHANCE * (100 / chosenItem.getSkillIncreasePct()), data);
            // Break item rand
