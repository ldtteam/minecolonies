...
public class EntityAICitizenWander extends Goal
{
    ...
    private WanderState readABook()
    {
        ...
        if (walkTo != null)
        {
            ...
            {
                citizen.setItemSlot(EquipmentSlotType.MAINHAND, ItemStack.EMPTY);
                walkTo = null;
                leisureSite = null;
            ...
            citizen.setItemSlot(EquipmentSlotType.MAINHAND, new ItemStack(Items.BOOK));
            return READ_A_BOOK;
        }

        final TileEntity blockEntity = citizen.level.getBlockEntity(leisureSite);
