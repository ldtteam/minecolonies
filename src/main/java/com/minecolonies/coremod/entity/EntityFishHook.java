...
public final class EntityFishHook extends Entity
{
    ...
    private void spawnLootAndExp(@NotNull final EntityCitizen citizen)
    {
        ...
        CompatibilityUtils.getWorld(this).addEntity(entityitem);
        CompatibilityUtils.getWorld(citizen).addEntity(new EntityXPOrb(CompatibilityUtils.getWorld(citizen),
                                                                          citizenPosX,
                                                                          citizenPosY + 0.D,
                                                                          citizenPosZ + 0.5,
