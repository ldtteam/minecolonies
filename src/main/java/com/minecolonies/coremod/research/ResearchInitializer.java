...
public class ResearchInitializer
{
    ...
    private static void buildTechnologyTree(final IGlobalResearchTree researchTree)
    {
        ...
        final GlobalResearch deeppockets = new GlobalResearch("deeppockets", "technology", "Deep Pockets", 4, new AdditionModifierResearchEffect(BUILDER_INV_SLOTS, 7));
        deeppockets.setRequirement(new BuildingResearchRequirement(4, "library"));

        final GlobalResearch loaded = new GlobalResearch("loaded", "technology", "Loaded", 5, new AdditionModifierResearchEffect(BUILDER_INV_SLOTS, 14));
        loaded.setRequirement(new BuildingResearchRequirement(5, "library"));

        final GlobalResearch heavilyloaded = new GlobalResearch("heavilyloaded", "technology", "Heavily Loaded", 6, new AdditionModifierResearchEffect(BUILDER_INV_SLOTS, 21));
