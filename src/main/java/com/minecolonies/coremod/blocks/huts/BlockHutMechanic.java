...
public class BlockHutMechanic extends AbstractBlockHut<BlockHutMechanic>
{
    ...
    public void onItemCrafted(final IColony colony, final PlayerEntity player)
    {
        ...
        if (colony.getResearchManager().getResearchEffects().getEffect("Mechanic", UnlockBuildingResearchEffect.class) == null)
        {
            player.sendMessage(new TranslationTextComponent("com.minecolonies.coremod.research.crafted", "mechanic"));
        }
    }
}
