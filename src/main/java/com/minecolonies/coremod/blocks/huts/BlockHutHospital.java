...
public class BlockHutHospital extends AbstractBlockHut<BlockHutHospital>
{
    ...
    public void onItemCrafted(final IColony colony, final PlayerEntity player)
    {
        ...
        if (colony.getResearchManager().getResearchEffects().getEffect("Hospital", UnlockBuildingResearchEffect.class) == null)
        {
            player.sendMessage(new TranslationTextComponent("com.minecolonies.coremod.research.crafted", "hospital"));
        }
    }
}
