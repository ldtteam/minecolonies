...
public final class ModInteractionsInitializer
{
    ...
    static
    {
        ...
        ModInteractionResponseHandlers.simpleNotification = DEFERRED_REGISTER.register(ModInteractionResponseHandlers.STANDARD.getPath(), () -> new InteractionResponseHandlerEntry.Builder()
                                                              .setResponseHandlerProducer(StandardInteraction::new)
                                                              .setRegistryName(ModInteractionResponseHandlers.SIMPLE_NOTIFICATION)
                                                              .createEntry());

        ModInteractionResponseHandlers.pos = DEFERRED_REGISTER.register(ModInteractionResponseHandlers.STANDARD.getPath(), () -> new InteractionResponseHandlerEntry.Builder()
                                               .setResponseHandlerProducer(PosBasedInteraction::new)
                                               .setRegistryName(ModInteractionResponseHandlers.POS)
                                               .createEntry());

        ModInteractionResponseHandlers.request = DEFERRED_REGISTER.register(ModInteractionResponseHandlers.STANDARD.getPath(), () -> new InteractionResponseHandlerEntry.Builder()
                                                   .setResponseHandlerProducer(RequestBasedInteraction::new)
                                                   .setRegistryName(ModInteractionResponseHandlers.REQUEST)
                                                   .createEntry());

        ModInteractionResponseHandlers.recruitment = DEFERRED_REGISTER.register(ModInteractionResponseHandlers.STANDARD.getPath(), () -> new InteractionResponseHandlerEntry.Builder()
