...
public class EntityInitializer
{
    ...
    {
        ModEntities.CITIZEN = (EntityType<? extends AbstractEntityCitizen>) EntityType.Builder
            .create(EntityCitizen::new, EntityClassification.CREATURE)
        ...
        ModEntities.MERCENARY = (EntityType<? extends CreatureEntity>) EntityType.Builder
            .create(EntityMercenary::new, EntityClassification.CREATURE)
            .setTrackingRange(ENTITY_TRACKING_RANGE)
            .setUpdateInterval(ENTITY_UPDATE_FREQUENCY)
            .size((float) CITIZEN_WIDTH, (float) CITIZEN_HEIGHT)
        ...
        ModEntities.MINECART = (EntityType<AbstractMinecartEntity>) EntityType.Builder
            .create(MinecoloniesMinecart::new, EntityClassification.MISC)
            .setTrackingRange(ENTITY_TRACKING_RANGE)
            .setUpdateInterval(ENTITY_UPDATE_FREQUENCY)
            .size(0.98F, 0.7F)
        ...
        ModEntities.FIREARROW = (EntityType<? extends AbstractArrowEntity>) EntityType.Builder
            .<AbstractArrowEntity> create(FireArrowEntity::new, EntityClassification.MISC)
            .setTrackingRange(ENTITY_TRACKING_RANGE)
            .setUpdateInterval(ENTITY_UPDATE_FREQUENCY_FISHHOOK)
            .size(0.5F, 0.5F)
            .setShouldReceiveVelocityUpdates(true)
