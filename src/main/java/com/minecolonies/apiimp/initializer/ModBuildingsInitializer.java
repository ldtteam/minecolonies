...
public final class ModBuildingsInitializer
{
    ...
    public static void init(final RegistryEvent.Register<BuildingEntry> event)
    {
        ...
        ModBuildings.farmer = new BuildingEntry.Builder()
                                ...
                                .addBuildingModuleProducer(BuildingFarmer.FarmerFieldsModule::new, () -> BuildingFarmer.FarmerFieldModuleView::new)
                                .addBuildingModuleProducer(() -> new FieldManagerWorkerBuildingModule(ModJobs.farmer, Skill.Stamina, Skill.Athletics, false, b -> 1), () -> WorkerBuildingModuleView::new)
        ...
        ModBuildings.plantation = new BuildingEntry.Builder()
                                    ...
                                    .addBuildingModuleProducer(() -> new FieldManagerWorkerBuildingModule(ModJobs.planter, Skill.Agility, Skill.Dexterity, false, (b) -> 1), () -> WorkerBuildingModuleView::new)
                                    .addBuildingModuleProducer(() -> new BuildingPlantation.CraftingModule(ModJobs.planter), () -> CraftingModuleView::new)
                                    .addBuildingModuleProducer(BuildingPlantation.PlantationFieldsModule::new, () -> BuildingPlantation.PlantationFieldModuleView::new)
                                    .addBuildingModuleViewProducer(() -> CrafterTaskModuleView::new)
                                    .addBuildingModuleProducer(() -> new SettingsModule()
                                                                       .with(AbstractCraftingBuildingModule.RECIPE_MODE, new CrafterRecipeSetting()), () -> SettingsModuleView::new)
                                    .createBuildingEntry();
