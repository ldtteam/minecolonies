...
public class ModModelTypeInitializer
{
    ...
    public static void init(final EntityRendererProvider.Context context)
    {
        ...
        ModModelTypes.NETHERWORKER = new SimpleModelType(ModModelTypes.NETHERWORKER_ID, 1, new ModelEntityNetherWorkerMale(context.bakeLayer(ClientRegistryHandler.MALE_BEEKEEPER)), new ModelEntityNetherWorkerFemale(context.bakeLayer(ClientRegistryHandler.FEMALE_BEEKEEPER)));
