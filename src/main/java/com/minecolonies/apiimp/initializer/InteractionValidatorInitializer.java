...
public class InteractionValidatorInitializer
{
    ...
    {
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(FURNACE_USER_NO_FUEL),
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(BAKER_HAS_NO_FURNACES_MESSAGE),
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(RAW_FOOD),
          citizen -> InventoryUtils.findFirstSlotInItemHandlerNotEmptyWith(new InvWrapper(citizen.getInventory()), ISCOOKABLE) > 0 && InventoryUtils.findFirstSlotInItemHandlerNotEmptyWith(new InvWrapper(citizen.getInventory()), ISFOOD) == 0);
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(NO_RESTAURANT),
          citizen -> citizen.getColony() != null && citizen.getSaturation() <= LOW_SATURATION && citizen.getCitizenEntity().isPresent() && citizen.getColony().getBuildingManager().getBestRestaurant(citizen.getCitizenEntity().get()) == null && InventoryUtils.findFirstSlotInItemHandlerNotEmptyWith(new InvWrapper(citizen.getInventory()), ISFOOD) == 0);

        InteractionValidatorRegistry.registerPosBasedPredicate(new TextComponentTranslation(COM_MINECOLONIES_COREMOD_JOB_DELIVERYMAN_CHESTFULL),
          (citizen, pos) ->
          {
              if (citizen.getJob() instanceof JobDeliveryman)
              {
                  ...
                  if (colony != null)
                  {
                      ...
                      if (building != null)
                      {
                          final IItemHandler inv = building.getCapability(ITEM_HANDLER_CAPABILITY, null);
                          if (inv != null)
                          {
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(COM_MINECOLONIES_COREMOD_JOB_DELIVERYMAN_NOWAREHOUSE),
          cit -> {
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(NO_FREE_FIELDS),
          citizen -> citizen.getWorkBuilding() instanceof BuildingFarmer && ((BuildingFarmer) citizen.getWorkBuilding()).hasNoFields());
        InteractionValidatorRegistry.registerPosBasedPredicate(new TextComponentTranslation(NO_SEED_SET),
          (citizen, pos) ->
          {
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(BAKER_HAS_NO_RECIPES),
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(COM_MINECOLONIES_COREMOD_ENTITY_WORKER_INVENTORYFULLCHEST), citizen -> citizen.getWorkBuilding() != null && InventoryUtils.isProviderFull(citizen.getWorkBuilding()));
        InteractionValidatorRegistry.registerPosBasedPredicate(
          new TextComponentTranslation(BUILDING_LEVEL_TOO_LOW), (citizen, pos) ->
          {
        ...
        InteractionValidatorRegistry.registerTokenBasedPredicate(new TextComponentTranslation(NORMAL_REQUEST),
          (citizen, token) -> {
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(FURNACE_USER_NO_ORE),
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(WATER_TOO_FAR),
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(NO_WORKERS_TO_DRAIN_SET),
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(NO_PLANT_GROUND_FLORIST),
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(NO_FLOWERS_IN_CONFIG),
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(NO_COMPOST),
          citizen ->
          {
              ...
              {
                  return InventoryUtils.getItemCountInItemHandler(new InvWrapper(citizen.getInventory()), IS_COMPOST) == 0 && !isThereCompostedLand((BuildingFlorist) buildingFlorist, buildingFlorist.getColony().getWorld());
              }
              return false;
          });


        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(NEEDS_BETTER_HUT),
          citizen -> {
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(DEMANDS_HOUSE), citizen -> ( citizen.getCitizenHappinessHandler()).getNumberOfDaysWithoutHouse() > DEMANDS_DAYS_WITHOUT_HOUSE);
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(NO_HOUSE),
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(DEMANDS_JOB), citizen -> ( citizen.getCitizenHappinessHandler()).getNumberOfDaysWithoutJob() > DEMANDS_DAYS_WITHOUT_JOB);
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(NO_JOB),
        ...
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(DEMANDS_TOOL), citizen -> ( citizen.getCitizenHappinessHandler()).getMaxOpenToolDays() > NO_TOOLS_DEMANDS_DAYS);
        InteractionValidatorRegistry.registerStandardPredicate(new TextComponentTranslation(NO_TOOL), citizen -> ( citizen.getCitizenHappinessHandler()).getMaxOpenToolDays() > NO_TOOLS_COMPLAINS_DAYS);
    }
}
