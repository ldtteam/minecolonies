...
public class DefaultRecruitmentItemsProvider implements DataProvider
{
    ...
    public CompletableFuture<?> run(final @NotNull CachedOutput cachedOutput)
    {
        return CompletableFuture.allOf(
            ...
            makeRecruitmentItem(cachedOutput, ModFoodItems.muffin, 5),
            makeRecruitmentItem(cachedOutput, ModFoodItems.veggie_quiche, 5),
            makeRecruitmentItem(cachedOutput, ModFoodItems.pasta_plain, 5),
            makeRecruitmentItem(cachedOutput, ModFoodItems.pottage, 5),
            ...
            makeRecruitmentItem(cachedOutput, ModFoodItems.steak_dinner, 7),
            makeRecruitmentItem(cachedOutput, ModFoodItems.hand_pie, 7),
            makeRecruitmentItem(cachedOutput, ModFoodItems.schnitzel, 7),
            ...
            makeRecruitmentItem(cachedOutput, ModFoodItems.lamb_stew, 8),
            makeRecruitmentItem(cachedOutput, ModFoodItems.sushi_roll, 8),
            makeRecruitmentItem(cachedOutput, ModFoodItems.eggplant_dolma, 8),
            makeRecruitmentItem(cachedOutput, ModFoodItems.pita_hummus, 8),
