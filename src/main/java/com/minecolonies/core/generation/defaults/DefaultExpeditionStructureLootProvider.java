    ...
    protected void registerTables(final @NotNull LootTableRegistrar registrar)
    {
        createStructureLootTable(ANCIENT_CITY_ID, registrar, builder -> builder.withPool(
          new LootPool.Builder().setRolls(SPECIAL_STRUCTURE_ROLLS)
            ...
            .add(LootItem.lootTableItem(Items.ENCHANTED_BOOK)
                   ...
                   .when(ExpeditionDifficultyCondition.forDifficulty(DIFF_3)))
            .add(createEncounterLootItem(WARDEN).setWeight(10).when(ExpeditionDifficultyCondition.forDifficulty(DIFF_3, DIFF_4)))
        ));
        ...
        createStructureLootTable(BASTION_REMNANT_ID, registrar, builder -> builder.withPool(
          new LootPool.Builder().setRolls(UNCOMMON_STRUCTURE_ROLLS)
            ...
            .add(createEncounterLootItem(HOGLIN)
                   .setWeight(100)
                   .when(ExpeditionDifficultyCondition.forDifficulty(DIFF_3)))
        ));
        ...
        createStructureLootTable(BURIED_TREASURE_ID, registrar, builder -> builder.withPool(
          new LootPool.Builder().setRolls(UNCOMMON_STRUCTURE_ROLLS)
            ...
            .add(LootItem.lootTableItem(Items.EMERALD)
                   .setWeight(25)
                   .when(ExpeditionDifficultyCondition.forDifficulty(DIFF_2, DIFF_3)))
            .add(createPotionItem(Potions.WATER_BREATHING)
                   .setWeight(15)
                   .when(ExpeditionDifficultyCondition.forDifficulty(DIFF_2, DIFF_3)))
        ...
        createStructureLootTable(FORTRESS_ID, registrar, builder -> builder.withPool(
          new LootPool.Builder().setRolls(COMMON_STRUCTURE_ROLLS)
            .add(LootItem.lootTableItem(Items.NETHER_BRICKS)
                   .setWeight(100)
                   .apply(SetItemCountFunction.setCount(SUPER_COMMON_ITEM_COUNT)))
            .add(LootItem.lootTableItem(Items.IRON_INGOT)
                   .setWeight(100)
        ...
        createStructureLootTable(MANSION_ID, registrar, builder -> builder.withPool(
          new LootPool.Builder().setRolls(UNCOMMON_STRUCTURE_ROLLS)
            ...
            .add(createEncounterLootItem(EVOKER)
                   .setWeight(50)
                   .when(ExpeditionDifficultyCondition.forDifficulty(DIFF_2, DIFF_3)))
            .add(createEncounterLootItem(VEX)
                   .setWeight(50)
                   .when(ExpeditionDifficultyCondition.forDifficulty(DIFF_2, DIFF_3)))
        ));
        ...
        createStructureLootTable(MINESHAFT_ID, registrar, builder -> builder.withPool(
          new LootPool.Builder().setRolls(COMMON_STRUCTURE_ROLLS)
            .add(LootItem.lootTableItem(Items.RAIL)
                   .setWeight(100)
                   .apply(SetItemCountFunction.setCount(SUPER_COMMON_ITEM_COUNT)))
            .add(LootItem.lootTableItem(Items.POWERED_RAIL)
                   .setWeight(75)
                   .apply(SetItemCountFunction.setCount(UNCOMMON_ITEM_COUNT)))
            .add(LootItem.lootTableItem(Items.DETECTOR_RAIL)
                   .setWeight(50)
                   .apply(SetItemCountFunction.setCount(UNCOMMON_ITEM_COUNT)))
            .add(LootItem.lootTableItem(Items.ACTIVATOR_RAIL)
                   .setWeight(50)
                   .apply(SetItemCountFunction.setCount(UNCOMMON_ITEM_COUNT)))
            .add(LootItem.lootTableItem(Items.IRON_INGOT)
                   .setWeight(50)
        ...
        createStructureLootTable(MONUMENT_ID, registrar, builder -> builder.withPool(
          new LootPool.Builder().setRolls(UNCOMMON_STRUCTURE_ROLLS)
            ...
            .add(createEncounterLootItem(ELDER_GUARDIAN)
                   .setWeight(5)
                   .when(ExpeditionDifficultyCondition.forDifficulty(DIFF_3)))
        ));
        ...
        createStructureLootTable(STRONGHOLD_ID, registrar, builder -> builder.withPool(
          new LootPool.Builder().setRolls(SPECIAL_STRUCTURE_ROLLS)
            .add(LootItem.lootTableItem(Items.STONE_BRICKS)
                   .setWeight(100)
                   .apply(SetItemCountFunction.setCount(SUPER_COMMON_ITEM_COUNT)))
            .add(LootItem.lootTableItem(Items.CRACKED_STONE_BRICKS)
                   .setWeight(100)
                   .apply(SetItemCountFunction.setCount(SUPER_COMMON_ITEM_COUNT)))
        ...
        createStructureLootTable(DESERT_PYRAMID_ID, registrar, builder -> builder.withPool(
          new LootPool.Builder().setRolls(UNCOMMON_STRUCTURE_ROLLS)
            .add(LootItem.lootTableItem(Items.SANDSTONE)
                   .setWeight(100)
                   .apply(SetItemCountFunction.setCount(SUPER_COMMON_ITEM_COUNT)))
            .add(LootItem.lootTableItem(Items.CUT_SANDSTONE)
                   .setWeight(100)
                   .apply(SetItemCountFunction.setCount(SUPER_COMMON_ITEM_COUNT)))
            .add(LootItem.lootTableItem(Items.IRON_INGOT)
                   .setWeight(75)
        ...
        createStructureLootTable(IGLOO_ID, registrar, builder -> builder.withPool(
          new LootPool.Builder().setRolls(UNCOMMON_STRUCTURE_ROLLS)
            .add(LootItem.lootTableItem(Items.SNOW)
                   .setWeight(100)
                   .apply(SetItemCountFunction.setCount(SUPER_COMMON_ITEM_COUNT)))
            ...
            .add(LootItem.lootTableItem(Items.SNOWBALL)
                   .setWeight(75)
                   .apply(SetItemCountFunction.setCount(COMMON_ITEM_COUNT)))
            .add(LootItem.lootTableItem(ModItems.lamb_stew)
                   .setWeight(50)
                   .apply(SetItemCountFunction.setCount(COMMON_ITEM_COUNT)))
            .add(LootItem.lootTableItem(Items.EMERALD).setWeight(25))
        ));
        ...
        createStructureLootTable(JUNGLE_TEMPLE_ID, registrar, builder -> builder.withPool(
          new LootPool.Builder().setRolls(UNCOMMON_STRUCTURE_ROLLS)
            ...
            .add(LootItem.lootTableItem(Items.COBWEB)
                   .setWeight(75)
                   .apply(SetItemCountFunction.setCount(COMMON_ITEM_COUNT)))
            .add(LootItem.lootTableItem(ModItems.pita_hummus)
                   .setWeight(50)
                   .apply(SetItemCountFunction.setCount(UNCOMMON_ITEM_COUNT)))
        ...
        createStructureLootTable(VILLAGE_DESERT_ID, registrar, builder -> {
            ...
            final LootPool.Builder pool = new LootPool.Builder().setRolls(COMMON_STRUCTURE_ROLLS)
                                            .add(LootItem.lootTableItem(Items.SANDSTONE).setWeight(crops.size() * 50).apply(SetItemCountFunction.setCount(SUPER_COMMON_ITEM_COUNT)))
