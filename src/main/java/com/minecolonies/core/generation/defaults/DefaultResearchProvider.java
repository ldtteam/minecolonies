 ...
 * Effect and Branch Identifiers are not stored to disk, but changing them may cause confusion with outside data packs.</p>
 */
public class DefaultResearchProvider extends AbstractResearchProvider
{
    ...
    private static final Identifier CIVIL  = Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian");
    private static final Identifier COMBAT = Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat");
    private static final Identifier TECH   = Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology");
    private static final Identifier UNLOCK = Identifier.fromNamespaceAndPath(Constants.MOD_ID, "unlockable");
    ...
    public Collection<ResearchEffect> getResearchEffectCollection()
    {
        ...
        //Multiplier and Addition modifiers have Research Constant Identifiers, and require setLevels.
        ...
        // Guard and Worker unlocks do not need a strength, but do have static Identifiers.
        ...
        // Building-focused unlocks are derived from the block hut name.  Do not manually add Identifiers as a string, as some building blocks have surprising names.
    ...
    {
        //Primary Research #1
        final Research stamina = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/stamina"), CIVIL).setTranslatedName("Stamina")
                                   .setOnlyChild()
                                   ...
                                   .addToList(r);
        final Research bandAid = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/bandaid"), CIVIL).setParentResearch(stamina)
                                   .setTranslatedName("Band Aid")
                                   .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/regeneration1.png"))
                                   .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 2)
                                   .addItemCost(Items.GOLDEN_CARROT, 1, provider)
                                   .addEffect(REGENERATION, 1)
                                   .addToList(r);
        final Research healingCream = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/healingcream"), CIVIL).setParentResearch(bandAid)
                                        .setTranslatedName("Healing Cream")
                                        .setTranslatedSubtitle("You missed a spot...")
                                        .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/regeneration2.png"))
                                        .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 3)
                                        .addItemCost(Items.GOLDEN_CARROT, 8, provider)
                                        .addEffect(REGENERATION, 2)
                                        .addToList(r);
        final Research bandages = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/bandages"), CIVIL).setParentResearch(healingCream)
                                    .setTranslatedName("Bandages")
                                    .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/regeneration3.png"))
                                    .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 4)
                                    .addItemCost(Items.GOLDEN_CARROT, 16, provider)
                                    .addEffect(REGENERATION, 3)
                                    .addToList(r);
        final Research compress = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/compress"), CIVIL).setParentResearch(bandages)
                                    .setTranslatedName("Compress")
                                    .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/regeneration4.png"))
                                    .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 5)
                                    .addItemCost(Items.GOLDEN_CARROT, 32, provider)
                                    .addEffect(REGENERATION, 4)
                                    .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/cast"), CIVIL).setParentResearch(compress)
          .setTranslatedName("Cast")
          .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/regeneration5.png"))
          .addItemCost(Items.GOLDEN_CARROT, 64, provider)
          .addEffect(REGENERATION, 5)
          .addToList(r);

        final Research resistance = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/resistance"), CIVIL).setParentResearch(stamina)
                                      .setTranslatedName("Resistance")
                                      .setSortOrder(2)
                                      .setIcon(Items.GLASS_BOTTLE)
                                      .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COOK_ID), 2)
                                      .addItemCost(Items.GOLDEN_APPLE, 1, provider)
                                      .addEffect(SATLIMIT, 1)
                                      .addToList(r);
        final Research resilience = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/resilience"), CIVIL).setParentResearch(resistance)
                                      .setTranslatedName("Resilience")
                                      .setIcon(Items.POTION)
                                      .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COOK_ID), 3)
                                      .addItemCost(Items.GOLDEN_APPLE, 8, provider)
                                      .addEffect(SATLIMIT, 2)
                                      .addToList(r);
        final Research vitality = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/vitality"), CIVIL).setParentResearch(resilience)
                                    .setTranslatedName("Vitality")
                                    .setIcon(Items.SPLASH_POTION)
                                    .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COOK_ID), 4)
                                    .addItemCost(Items.GOLDEN_APPLE, 16, provider)
                                    .addEffect(SATLIMIT, 3)
                                    .addToList(r);
        final Research fortitude = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/fortitude"), CIVIL).setParentResearch(vitality)
                                     .setTranslatedName("Fortitude")
                                     .setIcon(Items.HONEY_BOTTLE)
                                     .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COOK_ID), 5)
                                     .addItemCost(Items.GOLDEN_APPLE, 32, provider)
                                     .addEffect(SATLIMIT, 4)
                                     .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/indefatigability"), CIVIL).setParentResearch(fortitude)
        ...
        //Primary Research #2
        final Research keen = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/keen"), CIVIL).setTranslatedName("Keen")
                                .setSortOrder(2)
                                .setIcon(ModBlocks.blockHutLibrary.asItem())
                                .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.HOME_ID), 3)
                                .addItemCost(Items.BOOK, 3, provider)
                                .addEffect(ModBuildings.library.get().getBuildingBlock(), 1)
                                .addToList(r);
        final Research outpost = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/outpost"), CIVIL).setParentResearch(keen)
                                   .setTranslatedName("Outpost")
                                   .setIcon(ModBlocks.blockHutHome.asItem(), 50)
                                   .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.HOME_ID), 4)
                                   .addItemCost(Items.COOKED_BEEF, 64, provider)
                                   .addEffect(CITIZEN_CAP, 2)
                                   .addToList(r);
        final Research hamlet = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/hamlet"), CIVIL).setParentResearch(outpost)
                                  .setTranslatedName("Hamlet")
                                  .setIcon(ModBlocks.blockHutHome.asItem(), 75)
                                  .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.HOME_ID), 5)
                                  .addItemCost(Items.COOKED_BEEF, 128, provider)
                                  .addEffect(CITIZEN_CAP, 3)
                                  .addToList(r);
        final Research village = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/village"), CIVIL).setParentResearch(hamlet)
                                   .setTranslatedName("Village")
                                   .setIcon(ModBlocks.blockHutHome.asItem(), 100)
                                   .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.TOWNHALL_ID), 4)
                                   .addItemCost(Items.COOKED_BEEF, 256, provider)
                                   .addEffect(CITIZEN_CAP, 4)
                                   .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/city"), CIVIL).setParentResearch(village)
          .setTranslatedName("City")
          .setIcon(ModBlocks.blockHutHome.asItem(), 200)
          .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.TOWNHALL_ID), 5)
          .addItemCost(Items.COOKED_BEEF, 512, provider)
          .addEffect(CITIZEN_CAP, 5)
          .addToList(r);

        final Research diligent = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/diligent"), CIVIL).setParentResearch(keen)
                                    ...
                                    .addToList(r);
        final Research studious = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/studious"), CIVIL).setParentResearch(diligent)
                                    ...
                                    .addToList(r);
        final Research scholarly = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/scholarly"), CIVIL).setParentResearch(studious)
                                     ...
                                     .addToList(r);
        final Research reflective = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/reflective"), CIVIL).setParentResearch(scholarly)
                                      ...
                                      .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/academic"), CIVIL).setParentResearch(reflective)
        ...
        final Research haste = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/haste"), CIVIL).setParentResearch(keen)
                                  .setTranslatedName("Haste")
                                  .setTranslatedSubtitle("We have got to hurry up!")
                                  .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/speed1.png"))
                                  .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.TOWNHALL_ID), 3)
                                  .addItemCost(Items.RABBIT_FOOT, 1, provider)
                                  .addEffect(WALKING, 1)
                                  .setSortOrder(3)
                                  .addToList(r);
        final Research nimble = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/nimble"), CIVIL).setParentResearch(haste)
                                  ...
                                  .setSortOrder(3)
                                  .addToList(r);
        final Research agile = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/agile"), CIVIL).setParentResearch(nimble)
                                 .setTranslatedName("Agile")
                                 .setTranslatedSubtitle("So this is how it feels to be young again...")
                                 .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/speed2.png"))
                                 .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.TOWNHALL_ID), 4)
                                 .addItemCost(Items.RABBIT_FOOT, 8, provider)
                                 .addEffect(WALKING, 3)
                                 .addToList(r);
        final Research swift = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/swift"), CIVIL).setParentResearch(agile)
                                 .setTranslatedName("Swift")
                                 .setTranslatedSubtitle("They'll never see me coming.")
                                 .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/speed3.png"))
                                 .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.TOWNHALL_ID), 5)
                                 .addItemCost(Items.RABBIT_FOOT, 32, provider)
                                 .addEffect(WALKING, 4)
                                 .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/athlete"), CIVIL).setParentResearch(swift)
          .setTranslatedName("Athlete")
          .setTranslatedSubtitle("Try thinking as fast as your feet now!")
          .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/speed4.png"))
          .addItemCost(Items.RABBIT_FOOT, 64, provider)
          .addEffect(WALKING, 5)
          .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/rails"), CIVIL).setParentResearch(keen)
          .setTranslatedName("Rails")
          .setTranslatedSubtitle("Research is progressing right on track.")
          .setSortOrder(4)
          .setIcon(Items.DETECTOR_RAIL)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.DELIVERYMAN_ID), 3)
          .addItemCost(Items.RAIL, 64, provider)
          .addEffect(RAILS, 1)
          .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/vines"), CIVIL).setParentResearch(keen)
        ...
        // Primary Research #3
        final Research firstAid = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/firstaid"), CIVIL).setTranslatedName("First Aid")
                                    .setTranslatedSubtitle("First aid, second hand.")
                                    .setSortOrder(3)
                                    .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/hp1.png"))
                                    .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.TOWNHALL_ID), 1)
                                    .addItemCost(Items.HAY_BLOCK, 8, provider)
                                    .addEffect(HEALTH_BOOST, 1)
                                    .addToList(r);
        final Research firstAid2 = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/firstaid2"), CIVIL).setParentResearch(firstAid)
                                     .setTranslatedName("First Aid II")
                                     .setTranslatedSubtitle("Second Aid?")
                                     .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/hp2.png"))
                                     .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.TOWNHALL_ID), 2)
                                     .addItemCost(Items.HAY_BLOCK, 16, provider)
                                     .addEffect(HEALTH_BOOST, 2)
                                     .addToList(r);
        final Research lifesaver = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/lifesaver"), CIVIL).setParentResearch(firstAid2)
                                     .setTranslatedName("Lifesaver")
                                     .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/hp3.png"))
                                     .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.TOWNHALL_ID), 3)
                                     .addItemCost(Items.HAY_BLOCK, 32, provider)
                                     .addEffect(HEALTH_BOOST, 3)
                                     .addToList(r);
        final Research lifesaver2 = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/lifesaver2"), CIVIL).setParentResearch(lifesaver)
                                      .setTranslatedName("Lifesaver II")
                                      .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/hp4.png"))
                                      .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.TOWNHALL_ID), 4)
                                      .addItemCost(Items.HAY_BLOCK, 64, provider)
                                      .addEffect(HEALTH_BOOST, 4)
                                      .addToList(r);
        final Research guardianAngel = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/guardianangel"), CIVIL).setParentResearch(lifesaver2)
                                         ...
                                         .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/guardianangel2"), CIVIL).setParentResearch(guardianAngel)
          .setTranslatedName("Guardian Angel II")
          .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/hp6.png"))
          .addItemCost(Items.HAY_BLOCK, 256, provider)
          .addEffect(HEALTH_BOOST, 6)
          .addToList(r);

        final Research masks = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/masks"), CIVIL).setParentResearch(firstAid2)
          .setTranslatedName("Masks")
          .setTranslatedSubtitle("Solidarity")
          .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/hp4.png"))
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 3)
          .addItemCost(Items.WOOL.white(), 32, provider)
          .addEffect(MASKS, 1)
          .addToList(r);

        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/vaccines"), CIVIL).setParentResearch(masks)
        ...
        final Research circus = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/circus"), CIVIL).setParentResearch(firstAid)
                                  .setTranslatedName("Circus")
                                  .setSortOrder(2)
                                  .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/happy1.png"))
                                  .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COOK_ID), 2)
                                  .addItemCost(Items.CAKE, 1, provider)
                                  .addEffect(HAPPINESS, 1)
                                  .addToList(r);
        final Research festival = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/festival"), CIVIL).setParentResearch(circus)
                                    .setTranslatedName("Festival")
                                    .setTranslatedSubtitle("We Researchers may not be there, so don't look for us.")
                                    .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/happy2.png"))
                                    .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COOK_ID), 3)
                                    .addItemCost(Items.CAKE, 9, provider)
                                    .addEffect(HAPPINESS, 2)
                                    .addToList(r);
        final Research spectacle = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/spectacle"), CIVIL).setParentResearch(festival)
                                     .setTranslatedName("Spectacle")
                                     .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/happy3.png"))
                                     .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COOK_ID), 4)
                                     .addItemCost(Items.CAKE, 18, provider)
                                     .addEffect(HAPPINESS, 3)
                                     .addToList(r);
        final Research opera = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/opera"), CIVIL).setParentResearch(spectacle)
                                 .setTranslatedName("Opera")
                                 .setTranslatedSubtitle("Ear plugs not included.")
                                 .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/happy4.png"))
                                 .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COOK_ID), 5)
                                 .addItemCost(Items.CAKE, 27, provider)
                                 .addEffect(HAPPINESS, 4)
                                 .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/theater"), CIVIL).setParentResearch(opera)
          .setTranslatedName("Theater")
          .setTranslatedSubtitle("Oh don't be so dramatic!")
          .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/happy5.png"))
          .addItemCost(Items.ENCHANTED_GOLDEN_APPLE, 16, provider)
          .addEffect(HAPPINESS, 5)
          .addToList(r);

        final Research night_owl = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/nightowl"), CIVIL).setParentResearch(circus)
          ...
          .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/nightowl2"), CIVIL).setParentResearch(night_owl)
        ...
        final Research gourmand = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/gourmand"), CIVIL).setParentResearch(firstAid)
                                    .setTranslatedName("Gourmand")
                                    .setSortOrder(3)
                                    .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/saturation1.png"))
                                    .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COOK_ID), 2)
                                    .addItemCost(Items.COOKIE, 32, provider)
                                    .addEffect(SATURATION, 1)
                                    .addToList(r);
        final Research gorger = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/gorger"), CIVIL).setParentResearch(gourmand)
                                  .setTranslatedName("Gorger")
                                  .setTranslatedSubtitle("MORE!???")
                                  .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/saturation2.png"))
                                  .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COOK_ID), 3)
                                  .addItemCost(Items.COOKIE, 64, provider)
                                  .addEffect(SATURATION, 2)
                                  .addToList(r);
        final Research stuffer = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/stuffer"), CIVIL).setParentResearch(gorger)
                                   .setTranslatedName("Stuffer")
                                   .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/saturation3.png"))
                                   .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COOK_ID), 4)
                                   .addItemCost(Items.COOKIE, 128, provider)
                                   .addEffect(SATURATION, 3)
                                   .addToList(r);
        final Research epicure = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/epicure"), CIVIL).setParentResearch(stuffer)
                                   .setTranslatedName("Epicure")
                                   .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/saturation4.png"))
                                   .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COOK_ID), 5)
                                   .addItemCost(Items.COOKIE, 256, provider)
                                   .addEffect(SATURATION, 4)
                                   .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/glutton"), CIVIL).setParentResearch(epicure)
          .setTranslatedName("Glutton")
          .setTranslatedSubtitle("I think I'm finally satisfied... so what's for next course?")
          .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/saturation5.png"))
          .addItemCost(Items.COOKIE, 512, provider)
          .addEffect(SATURATION, 5)
          .addToList(r);

        // Primary Research #4.
        final Research higherLearning = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/higherlearning"), CIVIL).setTranslatedName("Higher Learning")
                                          .setTranslatedSubtitle("Well, we had to find something to occupy them.")
                                          .setSortOrder(4)
                                          .setOnlyChild()
                                          .setIcon(ModBlocks.blockHutSchool.asItem())
                                          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "residence"), 3)
                                          .addItemCost(Items.BOOK, 3, provider)
                                          .addEffect(ModBuildings.school.get().getBuildingBlock(), 1)
                                          .addToList(r);
        final Research moreBooks = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/morebooks"), CIVIL).setParentResearch(higherLearning)
                                     .setTranslatedName("More Books")
                                     .setTranslatedSubtitle("Of course I'm right, I read it in a book!")
                                     .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/xpgain1.png"))
                                     .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SCHOOL_ID), 1)
                                     .addItemCost(Items.BOOK, 6, provider)
                                     .addEffect(TEACHING, 1)
                                     .addToList(r);
        final Research bookworm = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/bookworm"), CIVIL).setParentResearch(moreBooks)
                                    .setTranslatedName("Bookworm")
                                    .setTranslatedSubtitle("We all know the early bird gets the book!")
                                    .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/xpgain2.png"))
                                    .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SCHOOL_ID), 3)
                                    .addItemCost(Items.BOOKSHELF, 6, provider)
                                    .addEffect(TEACHING, 2)
                                    .addToList(r);
        final Research bachelor = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/bachelor"), CIVIL).setParentResearch(bookworm)
                                    .setTranslatedName("Bachelor")
                                    .setTranslatedSubtitle("They now look like they know a lot, whether they do or not.")
                                    .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/xpgain3.png"))
                                    .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 3)
                                    .addItemCost(Items.BOOKSHELF, 12, provider)
                                    .addEffect(TEACHING, 3)
                                    .addToList(r);
        final Research master = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/master"), CIVIL).setParentResearch(bachelor)
                                  .setTranslatedName("Master")
                                  .setTranslatedSubtitle("At least they get a fancy title this time.")
                                  .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/xpgain4.png"))
                                  .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 5)
                                  .addItemCost(Items.BOOKSHELF, 32, provider)
                                  .addEffect(TEACHING, 4)
                                  .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/phd"), CIVIL).setParentResearch(master)
          .setTranslatedName("PhD")
          .setTranslatedSubtitle("Not that sort of doctor.")
          .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/xpgain5.png"))
          .addItemCost(Items.BOOKSHELF, 64, provider)
          .addEffect(TEACHING, 5)
          .addToList(r);

        final Research nurture = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/nurture"), CIVIL).setParentResearch(higherLearning)
                                   .setTranslatedName("Nurture")
                                   .setTranslatedSubtitle("It's just part of our nature now.")
                                   .setSortOrder(2)
                                   .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/childgrowth1.png"))
                                   .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SCHOOL_ID), 1)
                                   .addItemCost(Items.COOKED_CHICKEN, 32, provider)
                                   .addEffect(GROWTH, 1)
                                   .addToList(r);
        final Research hormones = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/hormones"), CIVIL).setParentResearch(nurture)
                                    .setTranslatedName("Hormones")
                                    .setTranslatedSubtitle("These are safe, right?")
                                    .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/childgrowth2.png"))
                                    .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SCHOOL_ID), 3)
                                    .addItemCost(Items.COOKED_CHICKEN, 64, provider)
                                    .addEffect(GROWTH, 2)
                                    .addToList(r);
        final Research puberty = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/puberty"), CIVIL).setParentResearch(hormones)
                                   .setTranslatedName("Puberty")
                                   .setTranslatedSubtitle("My voice sounds weird...")
                                   .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/childgrowth3.png"))
                                   .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 3)
                                   .addItemCost(Items.COOKED_CHICKEN, 128, provider)
                                   .addEffect(GROWTH, 3)
                                   .addToList(r);
        final Research growth = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/growth"), CIVIL).setParentResearch(puberty)
                                  .setTranslatedName("Growth")
                                  .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/childgrowth4.png"))
                                  .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 5)
                                  .addItemCost(Items.COOKED_CHICKEN, 256, provider)
                                  .addEffect(GROWTH, 4)
                                  .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/beanstalk"), CIVIL).setParentResearch(growth)
          .setTranslatedName("Beanstalk")
          .setTranslatedSubtitle("That's one heck of a growth spurt!")
          .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/childgrowth5.png"))
          .addItemCost(Items.COOKED_CHICKEN, 512, provider)
          .addEffect(GROWTH, 5)
          .addToList(r);

        // Primary Research #5
        final Research ambition = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/ambition"), CIVIL).setTranslatedName("Ambition")
          .setSortOrder(5)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/air"), CIVIL).setTranslatedName("Scuba")
        ...
        // Primary Research #6
        final Research remembrance = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/remembrance"), CIVIL)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/undertakeremergency"), CIVIL)
                .setParentResearch(remembrance)
                .setTranslatedName("Undertaker Emergency")
                .setSortOrder(3)
                .setIcon(ModBlocks.blockHutGraveyard.asItem())
                .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GRAVEYARD_ID), 2)
                .addItemCost(Items.IRON_BOOTS, 1, provider)
                .addEffect(UNDERTAKER_RUN, 1)
                .addToList(r);

        final Research resurrectChance1 = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/resurrectchance1"), CIVIL)
                .setParentResearch(remembrance)
                .setTranslatedName("Resurrection Chance I")
                .setTranslatedSubtitle("Use the right words")
                .setSortOrder(1)
                .setIcon(ModBlocks.blockHutGraveyard.asItem())
                .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GRAVEYARD_ID), 3)
                .addItemCost(Items.GHAST_TEAR, 1, provider)
                .addEffect(RESURRECT_CHANCE, 1)
                .addToList(r);

        final Research resurrectChance2 = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/resurrectchance2"), CIVIL)
                ...
                .setSortOrder(1)
                .setIcon(ModBlocks.blockHutGraveyard.asItem())
                .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GRAVEYARD_ID), 5)
                .addItemCost(Items.CHORUS_FRUIT, 16, provider)
                .addEffect(RESURRECT_CHANCE, 2)
                .addToList(r);

        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/raisingthedead"), CIVIL)
        ...
        final Research decayBonus1 = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/gravedecaybonus1"), CIVIL)
                .setParentResearch(remembrance)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/gravedecaybonus2"), CIVIL)
    ...
    {
        // Primary Research # 1
        final Research accuracy = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/accuracy"), COMBAT).setTranslatedName("Accuracy")
                                    .setOnlyChild()
                                    .setIcon(Items.IRON_SWORD)
                                    .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GUARD_TOWER_ID), 1)
                                    .addItemCost(Items.IRON_INGOT, 16, provider)
                                    .addEffect(GUARD_CRIT, 1)
                                    .addToList(r);
        final Research quickDraw = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/quickdraw"), COMBAT).setParentResearch(accuracy)
                                     .setTranslatedName("Quick Draw")
                                     .setIcon(Items.WOODEN_SWORD)
                                     .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BARRACKS_ID), 3)
                                     .addItemCost(Items.IRON_BLOCK, 2, provider)
                                     .addEffect(MELEE_DAMAGE, 1)
                                     .addToList(r);
        final Research powerAttack = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/powerattack"), COMBAT).setParentResearch(quickDraw)
                                       .setTranslatedName("Power Attack")
                                       .setIcon(Items.STONE_SWORD)
                                       .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COMBAT_ACADEMY_ID), 3)
                                       .addItemCost(Items.IRON_BLOCK, 4, provider)
                                       .addEffect(MELEE_DAMAGE, 2)
                                       .addToList(r);
        final Research cleave = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/cleave"), COMBAT).setParentResearch(powerAttack)
                                  .setTranslatedName("Cleave")
                                  .setIcon(Items.IRON_SWORD)
                                  .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GUARD_TOWER_ID), 10)
                                  .addItemCost(Items.IRON_BLOCK, 8, provider)
                                  .addEffect(MELEE_DAMAGE, 3)
                                  .addToList(r);
        final Research mightyCleave = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/mightycleave"), COMBAT).setParentResearch(cleave)
                                        .setTranslatedName("Mighty Cleave")
                                        .setIcon(Items.GOLDEN_SWORD)
                                        .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BARRACKS_ID), 5)
                                        .addItemCost(Items.IRON_BLOCK, 16, provider)
                                        .addEffect(MELEE_DAMAGE, 4)
                                        .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/savagestrike"), COMBAT).setParentResearch(mightyCleave)
        ...
        final Research preciseShot = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/preciseshot"), COMBAT).setParentResearch(accuracy)
                                       ...
                                       .addToList(r);
        final Research penetratingShot = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/penetratingshot"), COMBAT).setParentResearch(preciseShot)
                                           .setTranslatedName("Penetrating Shot")
                                           .setIcon(Items.BOW)
                                           .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.ARCHERY_ID), 3)
                                           .addItemCost(Items.FLINT, 32, provider)
                                           .addEffect(ARCHER_DAMAGE, 2)
                                           .addToList(r);
        final Research piercingShot = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/piercingshot"), COMBAT).setParentResearch(penetratingShot)
                                        ...
                                        .addToList(r);
        final Research woundingShot = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/woundingshot"), COMBAT).setParentResearch(piercingShot)
                                        ...
                                        .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/deadlyaim"), COMBAT).setParentResearch(woundingShot)
        ...
        // Primary Research #2
        final Research tacticTraining = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/tactictraining"), COMBAT).setTranslatedName("Tactic Training")
                                          .setSortOrder(2)
                                          .setIcon(ModBlocks.blockHutBarracksTower.asItem())
                                          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GUARD_TOWER_ID), 3)
                                          .addItemCost(Items.IRON_BLOCK, 3, provider)
                                          .addEffect(ModBuildings.barracks.get().getBuildingBlock(), 1)
                                          .addToList(r);
        final Research improvedSwords = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/improvedswords"), COMBAT).setParentResearch(tacticTraining)
                                          ...
                                          .addToList(r);
        final Research squireTraining = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/squiretraining"), COMBAT).setParentResearch(improvedSwords)
                                          ...
                                          .addToList(r);
        final Research knightTraining = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/knighttraining"), COMBAT).setParentResearch(squireTraining)
                                          .setTranslatedName("Knight Training")
                                          .setIcon(Items.BARREL)
                                          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COMBAT_ACADEMY_ID), 4)
                                          .addItemCost(Items.SHIELD, 8, provider)
                                          .addEffect(BLOCK_ATTACKS, 2)
                                          .addToList(r);
        final Research captainTraining = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/captaintraining"), COMBAT).setParentResearch(knightTraining)
                                           .setTranslatedName("Captain Training")
                                           .setIcon(Items.IRON_BARS)
                                           .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COMBAT_ACADEMY_ID), 5)
                                           .addItemCost(Items.SHIELD, 16, provider)
                                           .addEffect(BLOCK_ATTACKS, 3)
                                           .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/captainoftheguard"), COMBAT).setParentResearch(captainTraining)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/slicedanddecided"), COMBAT).setParentResearch(improvedSwords)
        ...
        final Research improvedBows = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/improvedbows"), COMBAT).setParentResearch(tacticTraining)
                                        ...
                                        .addToList(r);
        final Research trickShot = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/trickshot"), COMBAT).setParentResearch(improvedBows)
                                     ...
                                     .addToList(r);
        final Research multiShot = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/multishot"), COMBAT).setParentResearch(trickShot)
                                     .setTranslatedName("Multishot")
                                     .setTranslatedSubtitle("Known side effects include double vision double vision.")
                                     .setIcon(Items.TIPPED_ARROW)
                                     .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.ARCHERY_ID), 4)
                                     .addItemCost(Items.BOW, 9, provider)
                                     .addEffect(DOUBLE_ARROWS, 2)
                                     .addToList(r);
        final Research rapidShot = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/rapidshot"), COMBAT).setParentResearch(multiShot)
                                     .setTranslatedName("Rapid Shot")
                                     .setTranslatedSubtitle("Please leave the bow with more than you brought in.")
                                     .setIcon(ModItems.firearrow)
                                     .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.ARCHERY_ID), 5)
                                     .addItemCost(Items.BOW, 18, provider)
                                     .addEffect(DOUBLE_ARROWS, 3)
                                     .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/masterbowman"), COMBAT).setParentResearch(rapidShot)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/thathitthemark"), COMBAT).setParentResearch(improvedBows)
            .setTranslatedName("That hit the mark!")
            .setIcon(Items.CROSSBOW)
            .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.ARCHERY_ID), 3)
            .addItemCost(Items.CROSSBOW, 5, provider)
            .addEffect(MARKSMAN, 1)
            .addToList(r);

        final Research coffee = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/coffee"), COMBAT).setParentResearch(tacticTraining)
                                  .setTranslatedName("Coffee")
                                  .setTranslatedSubtitle("Keeps guards awake")
                                  .setIcon(Items.BED.lime())
                                  .addItemCost(Items.GOLDEN_CARROT, 4, provider)
                                  .addEffect(SLEEP_LESS, 1)
                                  .addToList(r);

        // Primary Research #3
        final Research avoidance = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/avoidance"), COMBAT).setTranslatedName("Avoidance")
                                     .setSortOrder(3)
                                     .setOnlyChild()
                                     ...
                                     .addToList(r);
        final Research parry = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/parry"), COMBAT).setParentResearch(avoidance)
                                 .setTranslatedName("Parry")
                                 .setIcon(Items.LEATHER_CHESTPLATE)
                                 .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SMELTERY_ID), 1)
                                 .addItemCost(Items.IRON_INGOT, 16, provider)
                                 .addEffect(MELEE_ARMOR, 1)
                                 .addToList(r);
        final Research riposte = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/riposte"), COMBAT).setParentResearch(parry)
                                   .setTranslatedName("Riposte")
                                   .setTranslatedSubtitle("Oh yeah? Well, I, uh, um...")
                                   .setIcon(Items.IRON_CHESTPLATE)
                                   .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COMBAT_ACADEMY_ID), 1)
                                   .addItemCost(Items.IRON_INGOT, 32, provider)
                                   .addEffect(MELEE_ARMOR, 2)
                                   .addToList(r);
        final Research duelist = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/duelist"), COMBAT).setParentResearch(riposte)
                                   .setTranslatedName("Duelist")
                                   .setIcon(Items.CHAINMAIL_CHESTPLATE)
                                   .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SMELTERY_ID), 3)
                                   .addItemCost(Items.IRON_INGOT, 64, provider)
                                   .addEffect(MELEE_ARMOR, 3)
                                   .addToList(r);
        final Research provost = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/provost"), COMBAT).setParentResearch(duelist)
                                   ...
                                   .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/masterswordsman"), COMBAT).setParentResearch(provost)
        ...
        final Research dodge = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/dodge"), COMBAT).setParentResearch(avoidance)
                                 ...
                                 .addToList(r);
        final Research improvedDodge = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/improveddodge"), COMBAT).setParentResearch(dodge)
                                         .setTranslatedName("Improved Dodge")
                                         .setTranslatedSubtitle("Dip")
                                         .setIcon(ModItems.pirateBoots_1)
                                         .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.ARCHERY_ID), 1)
                                         .addItemCost(Items.LEATHER, 32, provider)
                                         .addEffect(ARCHER_ARMOR, 2)
                                         .addToList(r);
        final Research evasion = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/evasion"), COMBAT).setParentResearch(improvedDodge)
                                   ...
                                   .addToList(r);
        final Research improvedEvasion = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/improvedevasion"), COMBAT).setParentResearch(evasion)
                                           ...
                                           .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/agilearcher"), COMBAT).setParentResearch(improvedEvasion)
        ...
        // Primary Research #4
        final Research improvedLeather = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/improvedleather"), COMBAT).setTranslatedName("Improved Leather")
                                           ...
                                           .addToList(r);
        final Research boiledLeather = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/boiledleather"), COMBAT).setParentResearch(improvedLeather)
                                         ...
                                         .addToList(r);
        final Research ironSkin = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/ironskin"), COMBAT).setParentResearch(boiledLeather)
                                    ...
                                    .addToList(r);
        final Research ironArmor = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/ironarmor"), COMBAT).setParentResearch(ironSkin)
                                     ...
                                     .addToList(r);
        final Research steelArmor = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/steelarmor"), COMBAT).setParentResearch(ironArmor)
                                      ...
                                      .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/platearmor"), COMBAT).setParentResearch(ironArmor)
                                     .setTranslatedName("Plate Armor")
                                     .setSortOrder(2)
                                     .setIcon(ModItems.plateArmorHelmet)
                                     .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BLACKSMITH_ID), 4)
                                     .addItemCost(Items.IRON_INGOT, 32, provider)
                                     .addEffect(PLATE_ARMOR, 1)
                                     .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/diamondskin"), COMBAT).setParentResearch(steelArmor)
        ...
        final Research telescope = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/telescope"), COMBAT).setParentResearch(ironSkin)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/standard"), COMBAT).setParentResearch(telescope)
          .setTranslatedName("Standard")
          .setIcon(ModItems.bannerRallyGuards)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BARRACKS_ID), 4)
          .addItemCost(Items.EMERALD, 32, provider)
          .addEffect(STANDARD, 1)
          .addToList(r);

        final Research regeneration = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/regeneration"), COMBAT).setParentResearch(improvedLeather)
                                        .setTranslatedName("Regeneration")
                                        .setSortOrder(2)
                                        .setOnlyChild()
                                        .setIcon(Items.GLISTERING_MELON_SLICE)
                                        .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GUARD_TOWER_ID), 2)
                                        .addItemCost(Items.EMERALD, 1, provider)
                                        .addEffect(RETREAT, 1)
                                        .addToList(r);
        final Research feint = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/feint"), COMBAT).setParentResearch(regeneration)
                                 .setTranslatedName("Feint")
                                 .setIcon(Items.LEATHER_BOOTS)
                                 .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GUARD_TOWER_ID), 4)
                                 .addItemCost(Items.EMERALD, 8, provider)
                                 .addEffect(FLEEING_DAMAGE, 1)
                                 .addToList(r);
        final Research fear = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/fear"), COMBAT).setParentResearch(feint)
                                .setTranslatedName("Fear")
                                .setIcon(Items.IRON_BOOTS)
                                .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GUARD_TOWER_ID), 8)
                                .addItemCost(Items.EMERALD, 16, provider)
                                .addEffect(FLEEING_DAMAGE, 2)
                                .addToList(r);
        final Research retreat = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/retreat"), COMBAT).setParentResearch(fear)
                                   .setTranslatedName("Retreat")
                                   .setTranslatedSubtitle("For strategic purposes, I assure you.")
                                   .setIcon(Items.GOLDEN_BOOTS)
                                   .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.GUARD_TOWER_ID), 12)
                                   .addItemCost(Items.EMERALD, 32, provider)
                                   .addEffect(FLEEING_DAMAGE, 3)
                                   .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/fullretreat"), COMBAT).setParentResearch(retreat)
        ...
        final Research avoid = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/avoid"), COMBAT).setParentResearch(regeneration)
                                 ...
                                 .addToList(r);
        final Research evade = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/evade"), COMBAT).setParentResearch(avoid)
                                 ...
                                 .addToList(r);
        final Research flee = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/flee"), COMBAT).setParentResearch(evade)
                                ...
                                .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/hotfoot"), COMBAT).setParentResearch(flee)
        ...
        final Research taunt =
          new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/taunt"), COMBAT)
            ...
            .addToList(r);
        final Research arrowUse = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/arrowuse"), COMBAT).setParentResearch(taunt)
                                    ...
                                    .addToList(r);
        final Research arrowPierce = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/arrowpierce"), COMBAT).setParentResearch(arrowUse)
                                       ...
                                       .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/druidpotion"), COMBAT).setParentResearch(arrowUse)
          ...
          .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/whirlwind"), COMBAT).setParentResearch(arrowPierce)
    ...
    {
        // Primary Research #1
        final Research biodegradable = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/biodegradable"), TECH).setTranslatedName("Biodegradable")
                                         .setTranslatedSubtitle("Where science meets dirt.")
                                         .setIcon(ModBlocks.blockHutComposter.asItem())
                                         .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.FARMER_ID), 3)
                                         .addItemCost(Items.BONE_MEAL, 64, provider)
                                         .addEffect(ModBuildings.composter.get().getBuildingBlock(), 1)
                                         .addToList(r);

        final Research podzolChance = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/podzolchance"), TECH).setParentResearch(biodegradable)
                                        .setTranslatedName("Podzol Chance")
                                        .setTranslatedSubtitle("Eww, sticky!")
                                        .setIcon(Items.PODZOL)
                                        .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COMPOSTER_ID), 2)
                                        .addItemCost(Items.PODZOL, 8, provider)
                                        .addEffect(PODZOL_CHANCE, 1)
                                        .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/podzolchance2"), TECH).setParentResearch(podzolChance)
                                        .setTranslatedName("Podzol Chance II")
                                        .setTranslatedSubtitle("Much easier than Silk Touch.")
                                        .setIcon(Items.PODZOL)
                                        .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COMPOSTER_ID), 3)
                                        .addItemCost(Items.PODZOL, 32, provider)
                                        .addEffect(PODZOL_CHANCE, 2)
                                        .addToList(r);

        final Research flowerPower = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/flowerpower"), TECH).setParentResearch(biodegradable)
                                       ...
                                       .addToList(r);
        final Research rainbowHeaven = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/rainbowheaven"), TECH).setParentResearch(biodegradable)
          ...
          .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/honeypot"), TECH).setParentResearch(rainbowHeaven)
          ...
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BEEKEEPER_ID), 3)
          .addItemCost(Items.BEEHIVE, 16, provider)
          .addEffect(BEEKEEP_2, 1)
          .addToList(r);

        final Research letItGrow = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/letitgrow"), TECH).setParentResearch(biodegradable)
                                     ...
                                     .addToList(r);
        final Research cropRotation = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/croprotation"), TECH).setParentResearch(letItGrow)
                                        .setTranslatedName("Crop Rotation")
                                        .setTranslatedSubtitle("Bigger = better")
                                        .setIcon(Items.DYE.green())
                                        .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.PLANTATION_ID), 3)
                                        .addItemCost(Items.SUGAR_CANE, 32, provider)
                                        .addItemCost(Items.CACTUS, 32, provider)
                                        .addEffect(PLANTATION_LARGE, 1)
                                        .addToList(r);

        final Research skilledButcher = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/skilledbutcher"), TECH).setParentResearch(biodegradable)
                                        .setTranslatedName("Skilled Butcher")
                                        .setTranslatedSubtitle("Measure twice, cut once!")
                                        .setIcon(Items.BEEF)
                                        .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.ENCHANTER_ID), 2)
                                        .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BLACKSMITH_ID), 2)
                                        .addItemCost(Items.DIAMOND_AXE, 1, provider)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/junglemaster"), TECH).setParentResearch(letItGrow)
          .setTranslatedName("Jungle Master")
          .setTranslatedSubtitle("Wimoweh Wimoweh Wimoweh")
          .setIcon(Items.VINE)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.PLANTATION_ID), 2)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/takingdivinglessons"), TECH).setParentResearch(letItGrow)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/exoticfruits"), TECH).setParentResearch(letItGrow)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/gargamel"), TECH).setParentResearch(cropRotation)
          .setTranslatedName("Gargamel")
          .setTranslatedSubtitle("The Root of all Evil")
          .setIcon(Items.CRIMSON_FUNGUS)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.PLANTATION_ID), 3)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.NETHERWORKER_ID), 3)
          .addItemCost(Items.CRIMSON_FUNGUS, 16, provider)
          .addItemCost(Items.WARPED_FUNGUS, 16, provider)
          .addEffect(PLANTATION_NETHER, 1)
          .addToList(r);

        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/greenrevolution"), TECH).setParentResearch(biodegradable)
            .setTranslatedName("Green Revolution")
            .setTranslatedSubtitle("I can feel it in the soil!")
            .setSortOrder(3)
            .setIcon(ModItems.compost)
            .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.FARMER_ID), 4)
            .addItemCost(ModItems.compost, 32, provider)
            .addEffect(GREEN_REVOLUTION, 1)
            .addToList(r);

        final Research bonemeal = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/bonemeal"), TECH).setParentResearch(biodegradable)
                                    .setTranslatedName("Bonemeal")
                                    .setTranslatedSubtitle("And to think this stuff feeds our plants...")
                                    .setSortOrder(3)
                                    .setIcon(Items.WHEAT_SEEDS)
                                    .addAlternateBuildingRequirement(List.of(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.FARMER_ID), Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COMPOSTER_ID)), 3)
                                    .addItemCost(Items.WHEAT_SEEDS, 64, provider)
                                    .addEffect(FARMING, 1)
                                    .addToList(r);
        final Research dung = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/dung"), TECH).setParentResearch(bonemeal)
                                .setTranslatedName("Dung")
                                .setTranslatedSubtitle("Fresh or not, here it comes!")
                                .setIcon(Items.BONE_MEAL)
                                .addAlternateBuildingRequirement(List.of(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.FARMER_ID), Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COMPOSTER_ID)), 4)
                                .addItemCost(Items.WHEAT_SEEDS, 128, provider)
                                .addEffect(FARMING, 2)
                                .addToList(r);
        final Research compost = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/compost"), TECH).setParentResearch(dung)
                                   .setTranslatedName("Compost")
                                   .setIcon(Items.BONE)
                                   .addAlternateBuildingRequirement(List.of(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.FARMER_ID), Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.COMPOSTER_ID)), 5)
                                   .addItemCost(Items.WHEAT_SEEDS, 256, provider)
                                   .addEffect(FARMING, 3)
                                   .addToList(r);
        final Research fertilizer = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/fertilizer"), TECH).setParentResearch(compost)
                                      ...
                                      .addEffect(FARMING, 4)
                                      .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/magiccompost"), TECH).setParentResearch(fertilizer)
        ...
        // Primary Research #2
        final Research softShoes = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/softshoes"), TECH).setTranslatedName("Soft Shoes")
        .setTranslatedSubtitle("Tiptoe through the tulips.")
        .setSortOrder(2)
        .setIcon(Items.LEATHER_BOOTS)
        .addItemCost(Items.WOOL.white(), 16, provider)
        .addItemCost(Items.FEATHER, 16, provider)
        .addEffect(SOFT_SHOES, 1)
        .addToList(r);

        // Primary Research #3
        final Research moreScrolls = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/morescrolls"), TECH).setTranslatedName("More Scrolls")
          .setSortOrder(3)
          .setIcon(ModItems.scrollHighLight)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "enchanter"), 3)
          .addItemCost(Items.PAPER, 64, provider)
          .addItemCost(ModItems.ancientTome, 1, provider)
          .addItemCost(Items.LAPIS_LAZULI, 64, provider)
          .addEffect(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "effects/morescrollsunlock"), 1)
          .addToList(r);

        final Research netherminer = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/opennether"), TECH).setParentResearch(moreScrolls)
        ...
        final Research alchemist = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/alchemist"), TECH).setParentResearch(netherminer)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/netherlog"), TECH).setParentResearch(netherminer)
                ...
                .addItemCost(ModItems.ancientTome, 1, provider)
                .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.NETHERWORKER_ID), 1)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/oceanheart"), TECH).setParentResearch(alchemist)
                ...
                .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.FISHERMAN_ID), 4)
                .addItemCost(Items.HEART_OF_THE_SEA, 1, provider)
                .addEffect(FISH_TREASURE, 1)
                .addToList(r);

        // Primary Research #4
        final Research stoneCake = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/stonecake"), TECH).setTranslatedName("Stone Cake")
                                     .setTranslatedSubtitle("Don't break a tooth!")
                                     .setSortOrder(4)
                                     .setIcon(ModBlocks.blockHutStonemason.asItem())
                                     .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.MINER_ID), 3)
                                     .addItemCost(Items.CHISELED_STONE_BRICKS, 64, provider)
                                     .addEffect(ModBuildings.stoneMason.get().getBuildingBlock(), 1)
                                     .addToList(r);
        final Research rockingRoll = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/rockingroll"), TECH).setParentResearch(stoneCake)
                                       .setTranslatedName("Rocking Roll")
                                       .setIcon(ModBlocks.blockHutCrusher.asItem())
                                       .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "stonemason"), 1)
                                       .addItemCost(Items.STONE, 64, provider)
                                       .addEffect(ModBuildings.crusher.get().getBuildingBlock(), 1)
                                       .addToList(r);

        final Research theFlintstones = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/theflintstones"), TECH).setParentResearch(stoneCake)
                                          .setTranslatedName("The Flintstones")
                                          .setTranslatedSubtitle("Yabba Dabba Doo!")
                                          .setIcon(ModBlocks.blockHutStoneSmeltery.asItem())
                                          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.STONE_MASON_ID), 1)
                                          .addItemCost(Items.BRICK, 64, provider)
                                          .addEffect(ModBuildings.stoneSmelter.get().getBuildingBlock(), 1)
                                          .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/knowtheend"), TECH).setParentResearch(theFlintstones)
          ...
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "baker"), 3)
          .addItemCost(Items.CHORUS_FRUIT, 64, provider)
          .addEffect(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "effects/knowledgeoftheendunlock"), 1)
          .addToList(r);


        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/gildedhammer"), TECH).setParentResearch(rockingRoll)
          .setTranslatedName("Gilded Hammer")
          .setTranslatedSubtitle("When in doubt, cover in shiny stuff.")
          .setIcon(Items.GOLD_BLOCK)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "crusher"), 3)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/depthknowledge"), TECH).setParentResearch(rockingRoll)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/pavetheroad"), TECH).setParentResearch(rockingRoll)
          ...
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "crusher"), 1)
          .addItemCost(ModTags.concreteItems, 32, provider)
          .addEffect(ModBuildings.concreteMixer.get().getBuildingBlock(), 1)
          .addToList(r);

        // Primary Research #5
        final Research woodwork = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/woodwork"), TECH).setTranslatedName("Woodwork")
                                    ...
                                    .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "lumberjack"), 3)
                                    .addItemCost(ItemTags.PLANKS, 64, provider)
                                    .addEffect(ModBuildings.sawmill.get().getBuildingBlock(), 1)
                                    .addToList(r);
        final Research stringWork = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/stringwork"), TECH).setParentResearch(woodwork)
                                      .setTranslatedName("Stringwork")
                                      .setIcon(ModBlocks.blockHutFletcher.asItem())
                                      .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SAWMILL_ID), 1)
                                      .addItemCost(Items.STRING, 16, provider)
                                      .addEffect(ModBuildings.fletcher.get().getBuildingBlock(), 1)
                                      .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/hotboots"), TECH).setParentResearch(stringWork)
          .setTranslatedName("Hot Boots")
          .setTranslatedSubtitle("Warmer on the outside.")
          .setIcon(Items.CAMPFIRE)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.FLETCHER_ID), 1)
          .addItemCost(Items.LEATHER, 32, provider)
          .addItemCost(Items.IRON_INGOT, 16, provider)
          .addEffect(FIRE_RES, 1)
          .addToList(r);

        final Research sieving = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/sieving"), TECH).setParentResearch(woodwork)
                                   .setTranslatedName("Sieving")
                                   .setTranslatedSubtitle("How did that get in there?")
                                   .setSortOrder(2)
                                   .setIcon(ModBlocks.blockHutSifter.asItem())
                                   .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.FISHERMAN_ID), 3)
                                   .addItemCost(Items.STRING, 64, provider)
                                   .addEffect(ModBuildings.sifter.get().getBuildingBlock(), 1)
                                   .addToList(r);
        final Research space = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/space"), TECH).setParentResearch(sieving)
                                 ...
                                 .addToList(r);
        final Research capacity = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/capacity"), TECH).setParentResearch(space)
                                    .setTranslatedName("Capacity")
                                    .setTranslatedSubtitle("Don't ask how we fit it all.")
                                    .setIcon(Items.CHEST_MINECART)
                                    .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.MINER_ID), 4)
                                    .addItemCost(ModBlocks.blockRack.asItem(), 32, provider)
                                    .addEffect(MINIMUM_STOCK, 2)
                                    .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/fullstock"), TECH).setParentResearch(capacity)
          .setTranslatedName("Full Stock!")
          .setTranslatedSubtitle("We might be able to squeeze in one more.")
          .setIcon(Items.ENDER_CHEST)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.MINER_ID), 5)
          .addItemCost(ModBlocks.blockRack.asItem(), 64, provider)
          .addEffect(MINIMUM_STOCK, 3)
          .addToList(r);

        final Research memoryAid = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/memoryaid"), TECH).setParentResearch(woodwork)
        ...
        final Research cheatSheet = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/cheatsheet"), TECH).setParentResearch(memoryAid)
                                      .setTranslatedName("Cheat Sheet")
                                      .setTranslatedSubtitle("So THAT's what I should be making!")
                                      .setIcon(Items.BOOK)
                                      .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SAWMILL_ID), 2)
                                      .addItemCost(Items.PAPER, 64, provider)
                                      .addEffect(RECIPES, 2)
                                      .setSortOrder(1)
                                      .addToList(r);
        final Research recipeBook = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/recipebook"), TECH).setParentResearch(cheatSheet)
                                      .setTranslatedName("Recipe Book")
                                      .setIcon(Items.ENCHANTED_BOOK)
                                      .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SAWMILL_ID), 3)
                                      .addItemCost(Items.PAPER, 128, provider)
                                      .addEffect(RECIPES, 3)
                                      .addToList(r);
        final Research rtm = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/rtm"), TECH).setParentResearch(recipeBook)
                               .setTranslatedName("RTM")
                               .setTranslatedSubtitle("I saw some information on this somewhere...")
                               .setIcon(Items.BOOKSHELF)
                               .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SAWMILL_ID), 4)
                               .addItemCost(Items.PAPER, 256, provider)
                               .addEffect(RECIPES, 4)
                               .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/rainman"), TECH).setParentResearch(rtm)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/warehousemaster"), TECH).setParentResearch(memoryAid)
          .setTranslatedName("Warehouse Master")
          .setTranslatedSubtitle("So many items to choose from!")
          .setIcon(ModBlocks.blockRack.asItem())
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.WAREHOUSE_ID), 3)
          .addAlternateBuildingRequirement(List.of(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SAWMILL_ID), Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.STONE_MASON_ID)), 3)
          .addItemCost(ModBlocks.blockRack.asItem(), 3, provider)
          .addEffect(RECIPE_MODE, 1)
          .setSortOrder(2)
          .addToList(r);

        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/moq"), TECH).setParentResearch(memoryAid)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/buildermodes"), TECH).setParentResearch(memoryAid)
          .setTranslatedName("Builder Modes")
          .setTranslatedSubtitle("Possibility Overload!")
          .setIcon(ModBlocks.blockHutBuilder.asItem())
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BUILDER_ID), 3)
          .addItemCost(Items.DIAMOND_AXE, 1, provider)
          .addEffect(BUILDER_MODE, 1)
          .setSortOrder(4)
          .addToList(r);

        final Research deepPockets = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/deeppockets"), TECH).setParentResearch(cheatSheet)
                                       .setTranslatedName("Deep Pockets")
                                       .setSortOrder(2)
                                       .setIcon(Items.DYED_SHULKER_BOX.pink())
                                       .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 4)
                                       .addItemCost(Items.EMERALD, 64, provider)
                                       .addEffect(CITIZEN_INV_SLOTS, 1)
                                       .setNoReset()
                                       .addToList(r);
        final Research loaded = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/loaded"), TECH).setParentResearch(deepPockets)
                                  .setTranslatedName("Loaded")
                                  .setIcon(Items.DYED_SHULKER_BOX.red())
                                  .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 5)
                                  .addItemCost(Items.EMERALD, 128, provider)
                                  .addEffect(CITIZEN_INV_SLOTS, 2)
                                  .setNoReset()
                                  .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/heavilyloaded"), TECH).setParentResearch(loaded)
          .setTranslatedName("Heavily Loaded")
          .setIcon(Items.DYED_SHULKER_BOX.blue())
          .setNoReset()
        ...
        // Primary Research #6
        final Research hot = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/hot"), TECH).setTranslatedName("Hot!")
                               .setSortOrder(6)
                               .setIcon(ModBlocks.blockHutSmeltery.asItem())
                               .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.MINER_ID), 2)
                               .addItemCost(Items.LAVA_BUCKET, 4, provider)
                               .addEffect(ModBuildings.smeltery.get().getBuildingBlock(), 1)
                               .addToList(r);
        final Research isThisRedstone = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/isthisredstone"), TECH).setParentResearch(hot)
                                          ...
                                          .addToList(r);
        final Research redstonePowered = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/redstonepowered"), TECH).setParentResearch(isThisRedstone)
                                           ...
                                           .addToList(r);
        final Research heavyMachinery = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/heavymachinery"), TECH).setParentResearch(redstonePowered)
                                          ...
                                          .addToList(r);
        final Research whatIsThisSpeed = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/whatisthisspeed"), TECH).setParentResearch(heavyMachinery)
                                           ...
                                           .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/lightning"), TECH).setParentResearch(whatIsThisSpeed)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/thoselungs"), TECH).setParentResearch(hot)
        ...
        // Primary Research #7
        final Research hittingIron = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/hittingiron"), TECH).setTranslatedName("Hitting Iron!")
                                       .setSortOrder(7)
                                       ...
                                       .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/assistanthammers"), TECH).setParentResearch(hittingIron)
            .setTranslatedName("Professional Assistant")
            .setIcon(ModItems.assistantHammer_Diamond)
            .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BLACKSMITH_ID), 1)
            .addItemCost(Items.IRON_BLOCK, 2, provider)
            .addEffect(ResearchConstants.BUILDERS_ASSISTANT_HAMMER, 1)
            .addToList(r);
        final Research strong = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/strong"), TECH).setParentResearch(hittingIron)
                                  ...
                                  .addToList(r);
        final Research hardened = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/hardened"), TECH).setParentResearch(strong)
                                    ...
                                    .addToList(r);
        final Research reinforced = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/reinforced"), TECH).setParentResearch(hardened)
                                      .setTranslatedName("Reinforced")
                                      .setIcon(Items.IRON_PICKAXE)
                                      .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BLACKSMITH_ID), 3)
                                      .addItemCost(Items.DIAMOND, 32, provider)
                                      .addEffect(TOOL_DURABILITY, 3)
                                      .addToList(r);
        final Research steelBracing = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/steelbracing"), TECH).setParentResearch(reinforced)
                                        .setTranslatedName("Steel Bracing")
                                        .setIcon(Items.GOLDEN_PICKAXE)
                                        .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BLACKSMITH_ID), 5)
                                        .addItemCost(Items.DIAMOND, 64, provider)
                                        .addEffect(TOOL_DURABILITY, 4)
                                        .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/diamondcoated"), TECH).setParentResearch(steelBracing)
        ...
        final Research ability = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/ability"), TECH).setParentResearch(hittingIron)
                                   .setTranslatedName("Ability")
                                   .setIcon(Items.GLOWSTONE_DUST)
                                   .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.MINER_ID), 1)
                                   .addItemCost(Items.IRON_INGOT, 64, provider)
                                   .addEffect(BLOCK_PLACE_SPEED, 1)
                                   .addToList(r);
        final Research skills = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/skills"), TECH).setParentResearch(ability)
                                  ...
                                  .addToList(r);
        final Research tools = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/tools"), TECH).setParentResearch(skills)
                                 .setTranslatedName("Tools")
                                 .setTranslatedSubtitle("Like breaking stuff, but in reverse!")
                                 .setIcon(Items.REDSTONE_LAMP)
                                 .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.BLACKSMITH_ID), 4)
                                 .addItemCost(Items.IRON_INGOT, 256, provider)
                                 .addEffect(BLOCK_PLACE_SPEED, 3)
                                 .addToList(r);
        final Research seemsAutomatic = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/seemsautomatic"), TECH).setParentResearch(tools)
                                          ...
                                          .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/madness"), TECH).setParentResearch(seemsAutomatic)
        ...
        final Research veinminer = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/veinminer"), TECH).setParentResearch(hittingIron)
                                     ...
                                     .addToList(r);
        final Research goodVeins = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/goodveins"), TECH).setParentResearch(veinminer)
                                     ...
                                     .addToList(r);
        final Research richVeins = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/richveins"), TECH).setParentResearch(goodVeins)
                                     ...
                                     .addToList(r);
        final Research amazingVeins = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/amazingveins"), TECH).setParentResearch(richVeins)
                                        ...
                                        .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/motherlode"), TECH).setParentResearch(amazingVeins)
        ...
        final Research whatYaNeed = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/whatyaneed"), TECH).setParentResearch(hittingIron)
                                      ...
                                      .addToList(r);
        final Research enhanced_gates1 = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/enhanced_gates1"), TECH).setParentResearch(whatYaNeed)
                                           ...
                                           .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/enhanced_gates2"), TECH).setParentResearch(enhanced_gates1)
    ...
    {
        Research stringmesh = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "unlockable/stringmesh"), UNLOCK)
            .setTranslatedName("String Mesh")
            .setIcon(ModItems.sifterMeshString)
            .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SIFTER_ID), 1)
            .setHidden()
            .setAutostart()
            .setInstant()
            .addEffect(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "effects/sifterstringunlock"), 1)
            .addToList(r);

        Research flintmesh = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "unlockable/flintmesh"), UNLOCK)
            .setTranslatedName("Flint Mesh")
            .setParentResearch(stringmesh)
            .setIcon(ModItems.sifterMeshString)
            .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SIFTER_ID), 3)
            .setHidden()
            .setAutostart()
            .setInstant()
            .addEffect(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "effects/sifterflintunlock"), 1)
            .addToList(r);

        Research ironmesh = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "unlockable/ironmesh"), UNLOCK)
            .setTranslatedName("Iron Mesh")
            .setParentResearch(flintmesh)
            .setIcon(ModItems.sifterMeshString)
            .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SIFTER_ID), 4)
            .setHidden()
            .setAutostart()
            .setInstant()
            .addEffect(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "effects/sifterironunlock"), 1)
            .addToList(r);

        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "unlockable/diamondmesh"), UNLOCK)
            .setTranslatedName("Diamond Mesh")
            .setParentResearch(ironmesh)
            .setIcon(ModItems.sifterMeshString)
            .addSingleBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.SIFTER_ID), 5)
            .setHidden()
            .setAutostart()
            .setInstant()
            .addEffect(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "effects/sifterdiamondunlock"), 1)
            .addToList(r);
