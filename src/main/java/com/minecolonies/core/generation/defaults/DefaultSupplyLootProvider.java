                ...
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                .add(LootItem.lootTableItem(ModItems.supplyCamp)
                                        ...
                                        .apply(SetNameFunction.setName(Component.translatableEscape("item.minecolonies.supply.free", ModItems.supplyCamp.get().getDescription()), SetNameFunction.Target.ITEM_NAME)))
                ...
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                .add(LootItem.lootTableItem(ModItems.supplyChest)
                                        .when(LootItemRandomChanceCondition.randomChance(0.1f))
                                       .apply(SetComponentsFunction.setComponent(ModDataComponents.SUPPLY_COMPONENT.value(), new SupplyData(false, true, -1)))
                                        .apply(SetNameFunction.setName(Component.translatableEscape("item.minecolonies.supply.free", ModItems.supplyChest.get().getDescription()), SetNameFunction.Target.ITEM_NAME)))
                                .add(LootItem.lootTableItem(ModItems.scrollBuff)
                                        .when(LootItemRandomChanceCondition.randomChance(0.2f))
                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(8))))
                        ));
