...
public class MinerAssignmentModuleView extends AbstractBuildingModuleView implements IAssignmentModuleView
{
    ...
    public void setHiringMode(final HiringMode hiringMode)
    {
        ...
        new QuarryHiringModeMessage(buildingView, hiringMode, getProducer().getRuntimeID()).sendToServer();
    }
    ...
    {
        return new SpecialAssignmentModuleWindow(this, Identifier.fromNamespaceAndPath(Constants.MOD_ID, "gui/layouthuts/layoutminerassignment.xml"));
    }
