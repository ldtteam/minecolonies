...
public class WindowClipBoard extends AbstractWindowSkeleton
{
    ...
    public WindowClipBoard(final IColonyView colony, boolean showImportant)
    {
        ...
        this.requestTreeWindowModule =
            registerLayoutModule(ClipboardRequestTreeWindowModule::new, new ClipboardRequestTreeWindowModule.Options(colony, () -> this.showImportant), 16, 44);
