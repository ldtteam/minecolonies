...
public class FemaleApiaryModel extends CitizenModel<CitizenRenderState>
{

    public FemaleApiaryModel(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition headNet_r1 = RoundHat.addOrReplaceChild("headNet_r1", CubeListBuilder.create().texOffs(96, 30).addBox(-4.0F, -3.0F, -3.7F, 8.0F, 6.0F, 8.0F, new CubeDeformation(0.59F)), PartPose.offsetAndRotation(0.0F, 3.6375F, 0.1F, 0.0873F, 0.0F, 0.0F));
        ...
        PartDefinition dress = bipedBody.addOrReplaceChild("dress", CubeListBuilder.create().texOffs(54, 30).addBox(-5.0F, -11.0F, -4.0F, 10.0F, 9.0F, 9.0F, new CubeDeformation(0.0F))
          .texOffs(56, 22).addBox(-5.0F, -12.0F, -3.0F, 10.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
          .texOffs(60, 15).addBox(-4.0F, -13.0F, -2.0F, 8.0F, 1.0F, 5.0F, new CubeDeformation(0.251F)), PartPose.offset(0.0F, 24.0F, -0.5F));
    ...
    public void setupAnim(@NotNull final CitizenRenderState state)
    {
        ...
        head.getChild("RoundHat").visible = isWorking(state) && displayHat(state);
    }
}
