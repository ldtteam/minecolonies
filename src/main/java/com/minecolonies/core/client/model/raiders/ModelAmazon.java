 ...
 */
public class ModelAmazon extends AmazonModel<AbstractEntityMinecoloniesMob>
{
    /**
     * Create an instance of it.
     */
    public ModelAmazon(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition hairBack1 = headDefinition.addOrReplaceChild("hairback1",
          CubeListBuilder.create()
            .texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, false)
            .texOffs(24, 4).addBox(-4.5F, -5.5F, -4.5F, 1.0F, 2.0F, 1.0F, false)
            .texOffs(24, 0).addBox(3.5F, -5.5F, -4.5F, 1.0F, 3.0F, 1.0F, false)
            .texOffs(0, 16).addBox(-5.0F, -7.2F, -4.8F, 10.0F, 2.0F, 8.0F, false)
        ...
        rightArm.addOrReplaceChild("handstuff",
          CubeListBuilder.create()
