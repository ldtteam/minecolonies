...
public class MaleForesterModel extends CitizenModel<CitizenRenderState>
{
    public MaleForesterModel(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public void setupAnim(@NotNull final CitizenRenderState state)
    {
        ...
        body.getChild("LogPack").getChild("Logs").visible = state.logsVisible;
