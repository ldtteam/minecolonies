...
public class MaleCookModel extends CitizenModel<CitizenRenderState>
{

    public MaleCookModel(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition hat = bipedHead.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(92, 36).addBox(-4.5F, -1.0F, -4.5F, 9.0F, 2.0F, 9.0F, new CubeDeformation(0.1F))
          .texOffs(98, 47).addBox(-3.5F, -2.0F, -3.7F, 7.0F, 1.0F, 8.0F, new CubeDeformation(0.1F))
          .texOffs(104, 56).addBox(-2.5F, -3.0F, -3.3F, 5.0F, 1.0F, 7.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, -8.0F, 0.0F, -0.0873F, 0.0F, 0.0F));

        PartDefinition BakerHat = bipedHead.addOrReplaceChild("BakerHat", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.1F, -6.6F, 2.0F, -0.7418F, 0.0F, 0.0F));
        ...
        PartDefinition tissue = bipedBody.addOrReplaceChild("tissue", CubeListBuilder.create().texOffs(0, 0).addBox(2.0F, -12.0F, 0.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
          .texOffs(0, 2).addBox(2.0F, -11.0F, 1.0F, 3.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 23.0F, 2.0F));
