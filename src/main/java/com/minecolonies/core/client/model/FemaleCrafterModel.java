...
public class FemaleCrafterModel extends CitizenModel<CitizenRenderState>
{

    public FemaleCrafterModel(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition feather_r1 = bipedHead.addOrReplaceChild("feather_r1", CubeListBuilder.create().texOffs(56, 15).addBox(-2.3F, -2.0F, -8.6F, 0.0F, 6.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -10.5F, 4.5F, 0.0F, -0.2356F, 0.0F));
        ...
        PartDefinition apronBody = bipedBody.addOrReplaceChild("apronBody", CubeListBuilder.create().texOffs(114, 11).addBox(-4.4F, -13.9F, -2.9F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.15F))
        ...
        PartDefinition apronRightLeg = bipedRightLeg.addOrReplaceChild("apronRightLeg", CubeListBuilder.create().texOffs(114, 19).addBox(-4.25F, -11.5F, -2.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.25F)), PartPose.offset(1.9F, 12.0F, 0.0F));
        ...
        PartDefinition apronLeftLeg = bipedLeftLeg.addOrReplaceChild("apronLeftLeg", CubeListBuilder.create().texOffs(106, 19).addBox(0.25F, -11.5F, -2.5F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.25F)), PartPose.offset(-1.9F, 12.0F, 0.0F));
    ...
    public void setupAnim(@NotNull final CitizenRenderState state)
    {
        ...
        body.getChild("bag").visible = state.hasPose(Pose.SLEEPING) == false;
