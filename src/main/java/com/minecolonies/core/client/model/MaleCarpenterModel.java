...
public class MaleCarpenterModel extends CitizenModel<CitizenRenderState>
{
    public MaleCarpenterModel(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition feather_r1 = Head.addOrReplaceChild("feather_r1", CubeListBuilder.create().texOffs(56, 15).addBox(-2.3F, -1.9F, -8.6F, 0.0F, 6.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -10.5F, 4.5F, 0.0F, -0.2356F, 0.0F));

        PartDefinition Beard1 = Head.addOrReplaceChild("Beard1", CubeListBuilder.create().texOffs(56, 0).addBox(-4.0F, -1.0F, 3.0F, 8.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
          .texOffs(74, 0).addBox(-4.0F, 0.0F, 3.0F, 8.0F, 7.0F, 1.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 1.0F, -7.0F));

        PartDefinition glasses = Head.addOrReplaceChild("glasses", CubeListBuilder.create().texOffs(92, 0).addBox(-5.5F, -3.6F, -1.3F, 7.0F, 7.0F, 1.0F, new CubeDeformation(-2.0F))
