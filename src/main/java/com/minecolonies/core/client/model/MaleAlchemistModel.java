...
public class MaleAlchemistModel extends CitizenModel<CitizenRenderState>
{

    public MaleAlchemistModel(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition shortBeard = Head.addOrReplaceChild("shortBeard", CubeListBuilder.create()
          .texOffs(24, 0).addBox(-3.5F, -24.0F, -4.0F, 7.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition glasses = Head.addOrReplaceChild("glasses", CubeListBuilder.create()
          ...
          .texOffs(80, 56).addBox(2.8F, -0.9F, -2.89F, 2.0F, 2.0F, 5.0F, new CubeDeformation(-0.6F)), PartPose.offsetAndRotation(0.0F, -3.7F, -2.1F, 0.0873F, 0.0F, 0.0F));
        ...
        PartDefinition Potion1 = Body.addOrReplaceChild("Potion1", CubeListBuilder.create()
          ...
          .texOffs(61, 40).addBox(-1.4152F, 5.1465F, -1.4F, 5.0F, 3.0F, 5.0F, new CubeDeformation(-1.3F)), PartPose.offset(1.1F, 4.78F, -4.2F));
        ...
        PartDefinition capeShoulderRight = Right_Arm.addOrReplaceChild("capeShoulderRight", CubeListBuilder.create().texOffs(110, 29).addBox(-2.0F, -1.0F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.2F)), PartPose.offset(-1.1F, -1.2F, 0.0F));
    ...
    public void setupAnim(@NotNull final CitizenRenderState state)
    {
        ...
        head.getChild("PointHat").visible = displayHat(state);
