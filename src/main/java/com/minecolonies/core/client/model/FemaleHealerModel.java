...
public class FemaleHealerModel extends CitizenModel<CitizenRenderState>
{

    public FemaleHealerModel(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition plagueMask = bipedHead.addOrReplaceChild("plagueMask", CubeListBuilder.create().texOffs(64, 17).mirror().addBox(-4.0F, -7.5F, -5.0F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
          .texOffs(24, 3).mirror().addBox(-4.0F, -5.5F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
          .texOffs(24, 0).mirror().addBox(-3.0F, -5.5F, -5.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
          .texOffs(28, 3).mirror().addBox(-1.0F, -5.5F, -5.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
          .texOffs(30, 0).mirror().addBox(1.0F, -5.5F, -5.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
          .texOffs(34, 3).mirror().addBox(3.0F, -5.5F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition Hat = bipedHead.addOrReplaceChild("Hat", CubeListBuilder.create().texOffs(90, 0).addBox(-4.5F, -0.6F, -6.5F, 9.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.7F, 0.0F, -0.0349F, 0.0F, 0.0F));
        ...
        PartDefinition glasses = bipedHead.addOrReplaceChild("glasses", CubeListBuilder.create().texOffs(53, 25).addBox(-5.5F, -3.6F, -1.3F, 7.0F, 7.0F, 1.0F, new CubeDeformation(-2.0F))
          .texOffs(53, 33).addBox(-1.5F, -3.6F, -1.3F, 7.0F, 7.0F, 1.0F, new CubeDeformation(-2.0F))
          .texOffs(54, 23).addBox(-1.0F, -0.6F, -2.55F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.3F))
          .texOffs(104, 21).addBox(-4.8F, -0.9F, -2.89F, 2.0F, 2.0F, 5.0F, new CubeDeformation(-0.6F))
          .texOffs(90, 21).addBox(2.8F, -0.9F, -2.89F, 2.0F, 2.0F, 5.0F, new CubeDeformation(-0.6F)), PartPose.offsetAndRotation(0.0F, -3.7F, -2.1F, 0.0873F, 0.0F, 0.0F));
        ...
        PartDefinition strapback_r1 = bag.addOrReplaceChild("strapback_r1", CubeListBuilder.create().texOffs(106, 47).addBox(-0.5F, -15.3F, 0.0F, 1.0F, 15.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.6402F, 10.0709F, 4.2192F, 0.0913F, 0.0015F, 0.7592F));

        PartDefinition straptop_r1 = bag.addOrReplaceChild("straptop_r1", CubeListBuilder.create().texOffs(103, 47).addBox(-0.5F, -1.8F, 0.3F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0119F, -1.1484F, 1.0134F, -1.5272F, 0.0F, 0.7854F));

        PartDefinition strapfrontb_r1 = bag.addOrReplaceChild("strapfrontb_r1", CubeListBuilder.create().texOffs(104, 53).addBox(-0.5F, -5.0F, 0.0F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.3176F, 2.5459F, -4.756F, -0.3229F, 0.0F, 0.7854F));

        PartDefinition strapfronta_r1 = bag.addOrReplaceChild("strapfronta_r1", CubeListBuilder.create().texOffs(102, 47).addBox(-0.5F, -9.0F, 0.0F, 1.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.676F, 9.5395F, -4.0545F, 0.1134F, 0.0F, 0.7854F));
        ...
        PartDefinition rightarmcoat = bipedRightArm.addOrReplaceChild("rightarmcoat", CubeListBuilder.create().texOffs(108, 40).mirror().addBox(-2.1F, 3.0F, -2.5F, 4.0F, 7.0F, 5.0F, new CubeDeformation(-0.01F)).mirror(false), PartPose.offset(-0.9F, -6.0F, 0.0F));
        ...
        PartDefinition leftarmcoat = bipedLeftArm.addOrReplaceChild("leftarmcoat", CubeListBuilder.create().texOffs(108, 52).mirror().addBox(1.7F, -2.0F, -2.5F, 4.0F, 7.0F, 5.0F, new CubeDeformation(-0.01F)).mirror(false), PartPose.offset(-3.2F, -1.0F, 0.0F));
    ...
    public void setupAnim(@NotNull final CitizenRenderState state)
    {
        ...
        head.getChild("plagueMask").visible = state.hasPose(Pose.SLEEPING) == false && isWorking(state);
        body.getChild("bag").visible = state.hasPose(Pose.SLEEPING) == false  && isWorking(state);
    }
}
