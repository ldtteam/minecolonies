...
public class MaleSwineHerderModel extends CitizenModel<AbstractEntityCitizen>
{

    public MaleSwineHerderModel(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        PartDefinition strapfrontb_r2 = carrotBag.addOrReplaceChild("strapfrontb_r2", CubeListBuilder.create().texOffs(123, 55).addBox(-0.5F, -5.6F, 0.0F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.7901F, 9.9854F, -4.2831F, -0.1448F, 0.0227F, 0.743F));

        PartDefinition strapfronta_r1 = carrotBag.addOrReplaceChild("strapfronta_r1", CubeListBuilder.create().texOffs(126, 50).addBox(-0.5F, -4.5F, 0.0F, 1.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.1004F, 2.7895F, -2.7598F, -0.1571F, 0.0F, 0.7854F));
        ...
        PartDefinition bipedRightArm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
          .texOffs(40, 32).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(-5.0F, 2.0F, 0.0F, 0.0F, 0.0F, 0.3927F));
