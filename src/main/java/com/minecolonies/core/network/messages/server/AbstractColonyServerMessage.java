...
public abstract class AbstractColonyServerMessage extends AbstractServerPlayMessage
{
    ...
    protected abstract void onExecute(final IPayloadContext ctxIn, final ServerPlayer player, final IColony colony);
    ...
    @Override
    public final void onExecute(final IPayloadContext ctxIn, final ServerPlayer player)
    {
