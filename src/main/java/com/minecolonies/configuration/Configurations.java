...
public class Configurations
{
    ...
    public static final boolean DEFAULT_DELIVERYMANINFINITERESOURCES = true;//TODO change to false when material handling is implemented
    ...
    public static boolean deliverymanInfiniteResources;
