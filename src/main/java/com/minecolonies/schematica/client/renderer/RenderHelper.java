...
public class RenderHelper {
	...
	public static void drawCuboidSurface(Vector3f zero, Vector3f size, int sides, float red, float green, float blue, float alpha) {
		vecZero.set(zero.x - Config.blockDelta, zero.y - Config.blockDelta, zero.z - Config.blockDelta);
		vecSize.set(size.x + Config.blockDelta, size.y + Config.blockDelta, size.z + Config.blockDelta);
