...
public interface IRequestHandler
{
    ...
    /**
     * Method used to assign a given request to a resolver. Does take a given blacklist of resolvers into account. Uses the default
     * assigning strategy: {@link
    ...
    /**
     * Method used to reassign the request to a resolver that is not in the given blacklist. Cancels the request internally without notify
     * the requester, and attempts a reassign.
    ...
    /**
     * Method used to handle requests that were overruled or cancelled. Cancels all children first, handles the creation of clean up
     * requests.
     *
    ...
    /**
     * Method called when the given manager gets notified of the receiving of a given task by its requester. All communication with the
     * resolver should be aborted by this time, so
