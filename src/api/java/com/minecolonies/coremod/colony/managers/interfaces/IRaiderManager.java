...
public interface IRaiderManager
{
     ...
     */
    void registerRaider(@NotNull final IBaseMinecoloniesMob raider);
     ...
     */
    void unregisterRaider(@NotNull final IBaseMinecoloniesMob raider, final WorldServer world);
     ...
     */
    List<IBaseMinecoloniesMob> getHorde(final WorldServer world);
