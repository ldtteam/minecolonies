...
public interface IBuildingManager
{
     ...
     */
    void addNewField(final IScarecrow tileEntity, final BlockPos pos, final World world);
     ...
     */
    @Nullable
    IScarecrow getFreeField(final int owner, final World world);
     ...
     */
    @Nullable
    IBuilding addNewBuilding(@NotNull final ITileEntityColonyBuilding tileEntity, final World world);
     ...
     */
    BlockPos getBestRestaurant(final IEntityCitizen citizen);
