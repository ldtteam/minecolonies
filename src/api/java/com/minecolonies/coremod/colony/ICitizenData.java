...
import com.minecolonies.coremod.entity.citizenhandlers.ICitizenHappinessHandler;
...
public interface ICitizenData extends INBTSerializable<NBTTagCompound>
{
     ...
     */
    @NotNull
    Optional<IEntityCitizen> getCitizenEntity();
     ...
     */
    void setCitizenEntity(@Nullable IEntityCitizen citizen);
    ...
    /**
     * Updates {@link IEntityCitizen} for the instance.
     */
