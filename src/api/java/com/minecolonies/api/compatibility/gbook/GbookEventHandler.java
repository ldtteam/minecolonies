...
public class GbookEventHandler
{
    ...
    public static void checkGbookGiven(final EntityJoinWorldEvent event)
    {
        ...
        if (Configurations.gameplay.playerGetsGuidebookOnFirstJoin && entity instanceof EntityPlayer && !entity.getEntityWorld().isRemote && !entity.getTags()
                                                                                                                                                .contains(bookPlayerTag))
        {
