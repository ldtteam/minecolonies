...
import gigaherz.guidebook.shadow.common.OreDictionaryHelper;
...
public class Stack implements IDeliverable
{
    ...
    public Stack(@NotNull final ItemStack stack, @NotNull final boolean matchMeta, @NotNull final boolean matchNBT, @NotNull final boolean matchOreDic, @NotNull final ItemStack result)
    {
        this.stack = stack;
