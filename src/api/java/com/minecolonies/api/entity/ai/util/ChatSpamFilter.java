...
public class ChatSpamFilter
{
     ...
     * 30 Seconds.
     */
    public static final int BASE_TIMEOUT = 30 * 20;
     ...
     * 10 Minutes.
     */
    public static final int MAX_TIMEOUT = 20 * 60 * 10;
     ...
     */
    public ChatSpamFilter(final ICitizenData citizenData)
    {
    ...
    public void talkWithoutSpam(final String key, final Object... chat)
    {
        ...
        final AbstractEntityCitizen worker = citizenData.getCitizenEntity().get();
