...
/**
 * Constants for GUI translations.
 */
public class GuiTranslationConstants
{
    ...
    @NonNls
    public static final String FIELD_LIST_LABEL_DISTANCE               = "com.minecolonies.coremod.gui.workerhuts.fields.distance";
    @NonNls
    ...
    @NonNls
    public static final String FIELD_LIST_PLANTATION_DIRECTION         = "com.minecolonies.coremod.gui.workerhuts.fields.plantation.direction.exact";
    @NonNls
    ...
    // Expeditionary window
    @NonNls
    public static final String EXPEDITIONARY_DIFFICULTY        = "com.minecolonies.gui.expedition.difficulty";
    @NonNls
    public static final String EXPEDITIONARY_DIFFICULTY_PREFIX = "com.minecolonies.gui.expedition.difficulty.";
}
